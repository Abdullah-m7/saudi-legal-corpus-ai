...
- **Retrieval eval pack** — realistic Arabic gold queries over the unified index
  ...
  deterministic results. **Current: top-1 93.7% / top-3 98.3% / top-5 99.0% / MRR@5 0.9594**
  over the 11430-record index with **414 golds** — expanded from 40 (v2: gtp-001..007 +
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 193 tracks' existing free-text
  ...
  distribution: **103 Tier 1, 42 Tier 2, 25 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  ...
  **11,774 chunks from 11,430 source records** — only **185 records (1.619%)**
