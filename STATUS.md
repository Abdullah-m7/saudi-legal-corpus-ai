...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **184 tracks; primary Arabic governing 11317; reference 614; registry-counted
  12212.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (11148 records) as a projection (not added to totals). See
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 184 tracks' existing free-text
  ...
  distribution: **101 Tier 1, 36 Tier 2, 24 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  layer over the unified index (11148 records), preparing the corpus for a
  ...
  **11,485 chunks from 11,148 source records** — only **180 records (1.615%)**
