...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **183 tracks; primary Arabic governing 11273; reference 614; registry-counted
  12168.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (11104 records) as a projection (not added to totals). See
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 183 tracks' existing free-text
  ...
  distribution: **101 Tier 1, 36 Tier 2, 23 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  layer over the unified index (11104 records), preparing the corpus for a
  ...
  **11,440 chunks from 11,104 source records** — only **179 records (1.612%)**
