...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **122 tracks; primary Arabic governing 8528; reference 614; registry-counted
  9423.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (8359 records) as a projection (not added to totals). See
...
## Corpus-value features — verification tiers, coverage gap map
