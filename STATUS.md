...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **125 tracks; primary Arabic governing 8818; reference 614; registry-counted
  9713.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (8649 records) as a projection (not added to totals). See
