...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **189 tracks; primary Arabic governing 11446; reference 614; registry-counted
  12341.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (11277 records) as a projection (not added to totals). See
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 189 tracks' existing free-text
  ...
  distribution: **102 Tier 1, 39 Tier 2, 25 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  ...
  **11,618 chunks from 11,277 source records** — only **183 records (1.623%)**
