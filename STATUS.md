...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **254 tracks; primary Arabic governing 14735; reference 614; registry-counted
  15630.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (14566 records) as a projection (not added to totals). See
