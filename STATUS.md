...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **179 tracks; primary Arabic governing 11123; reference 614; registry-counted
  12018.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (10954 records) as a projection (not added to totals). See
...
- **Retrieval eval pack** — realistic Arabic gold queries over the unified index
  ...
  deterministic results. **Current: top-1 93.3% / top-3 98.2% / top-5 99.0% / MRR@5 0.9565**
  over the 10954-record index with **386 golds** — expanded from 40 (v2: gtp-001..007 +
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 179 tracks' existing free-text
  ...
  distribution: **101 Tier 1, 34 Tier 2, 21 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  layer over the unified index (10954 records), preparing the corpus for a
  ...
  **11,290 chunks from 10,954 source records** — only **179 records (1.634%)**
