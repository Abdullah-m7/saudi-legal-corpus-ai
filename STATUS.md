...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **123 tracks; primary Arabic governing 8594; reference 614; registry-counted
  9489.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (8425 records) as a projection (not added to totals). See
...
- **`make qa-gate`** — one command, everything must pass: **[1]** every
  ...
  `EXCLUDED` dict, currently empty); **[2]** generator idempotence — 129 deterministic generators
