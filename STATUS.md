...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 198 tracks' existing free-text
  ...
  distribution: **105 Tier 1, 45 Tier 2, 25 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  ...
  **11,873 chunks from 11,528 source records** — only **186 records (1.613%)**
