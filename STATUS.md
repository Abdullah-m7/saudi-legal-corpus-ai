...
- **Corpus registry index foundation completed** — a canonical, machine-readable
  ...
  boundaries, and validation targets. **187 tracks; primary Arabic governing 11394; reference 614; registry-counted
  12289.** PDPL and Investment Arabic tracks are **verified against official
  published text** (SDAIA / MISA). The registry also records the unified retrieval
  index (11225 records) as a projection (not added to totals). See
...
- **Verification-tier taxonomy** — a purely additive, read-only derived
  classification layer over all 187 tracks' existing free-text
  ...
  distribution: **102 Tier 1, 38 Tier 2, 24 Tier 3, 23 Tier 4**. No existing
...
- **Embeddings-ready chunking layer** — a purely additive text-segmentation
  layer over the unified index (11225 records), preparing the corpus for a
  ...
  **11,565 chunks from 11,225 source records** — only **182 records (1.621%)**
