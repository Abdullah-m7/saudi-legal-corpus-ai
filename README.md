...
PDPL law 43 + PDPL regulation 38 + Investment law 16 + Investment regulation 37 +
Civil Transactions Law 721 — 9 tracks, primary Arabic 1305, registry-counted 1867;
PDPL and Investment Arabic are verified against official published text, Civil is
owner-provided official text) with counts, paths, statuses, boundaries, and
validation targets, plus the unified retrieval index (1136).
Validate: `make corpus-registry-validate`. A **corpus export** (v1) provides a deterministic
