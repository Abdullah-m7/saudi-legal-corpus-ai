...
8 tracks, primary Arabic 584, registry-counted 1146; PDPL and Investment Arabic
are verified against official published text) with counts, paths, statuses,
boundaries, and validation targets, plus the unified retrieval index (415).
