...
BM25 baseline, and the example-record figure) are openly available in the
repository \url{https://github.com/Abdullah-m7/saudi-legal-corpus-ai} and are
archived on Zenodo under the MIT license. The version described in this
paper is v1.0.2, \textbf{DOI:
