...
\begin{abstract}
\noindent
Seventy-five of the articles of the Saudi Law of Sharia Procedure have been
repealed. The instrument is still in force, still cited, and still read by
practitioners --- but more than a third of it no longer says anything. How
...
A practitioner opens the Law of Sharia Procedure and turns to article 60. It
is not there --- or rather, it is there and it is empty, repealed and left in
place so that the numbering of the articles around it survives. Seventy-five
of that instrument's articles are in the same condition. It remains in force;
what remains of it is roughly two-thirds of what was enacted.
...
either absent, or present as prose a human must read. There is no jurisdiction
in the Arab world for which the question has been asked at corpus scale, and
few anywhere.
...
Share of changed articles in the ten most changed instruments & 34.4\% \\
...
the corpus, in one instrument. The Commercial Courts Law shows the same
signature at smaller scale: 20 of its 21 changed articles are repeals. This is
...
The fiscal instruments deserve a note of their own. Four of the twelve most
changed instruments are tax or tax-adjacent, and between them they hold 147
changed articles. That is consistent with what one would expect of a system
...
changed. But roughly one amendment in five replaces most of the article's
wording. Article 72 of the Law of the Judiciary retains under a tenth of its
former vocabulary and shrank from 29 tokens to 6; article 30 of the Code of
Law Practice, likewise, from 34 to 14. An amendment, in other words, is not a
category with a typical magnitude; it is a label covering interventions that
differ by an order of magnitude in what they do to the text. A system that
tells a reader only that an article `has been amended' has told them very
little.
...
References an instrument makes to its own articles sit at the base rate.
References it makes to another instrument's articles are more than twice as
likely to point at text that has moved.
...
\paragraph{Dates are too sparse for a time series.} Only 174 of 759
article-amendment pairs carry a Gregorian date, and the instruments that carry
