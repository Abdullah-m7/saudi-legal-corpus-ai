...
carrying materially conflicting scope. The clearest is
...
is reporting drafting convention plus paraphrase. We would expect the same
two-order-of-magnitude gap --- from 198 lexically divergent terms to four
materially conflicting ones among those examined --- in other jurisdictions,
and measuring it elsewhere would be a useful test of that expectation.
