...
- [x] visually rendered and inspected all 8 pages after the final table/list rebuild, including corrected numbered-list hanging indents; no clipping, overlap, broken tables or missing glyphs observed;
