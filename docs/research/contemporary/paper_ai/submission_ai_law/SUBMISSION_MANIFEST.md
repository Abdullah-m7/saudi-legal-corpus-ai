...
**Prepared:** 2026-09-01  
**State:** `TEXT_PACKAGE_READY__EDITABLE_DOCX_AND_HUMAN_METADATA_OPEN`  
...
- editable source required; Word is the journal default and `.docx` is the next packaging operation;
