...
.PHONY: help data jsonl markdown validate book1-validate test html pdf build all clean \
        ...
        official-arabic-queue-p0-resolution-validate official-arabic-p1-batch1-review-validate
...
# -- Official Arabic P1 low-similarity batch 1 review (triage only; promotes nothing) --
official-arabic-p1-batch1-review-validate:
	$(PY) scripts/validate_official_arabic_p1_batch1_review.py
