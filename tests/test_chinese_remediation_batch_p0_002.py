"""Chinese remediation Batch P0-002 tests (scoped internal Chinese draft, 20 Bab 4 articles).

The batch creates new internal Chinese reference text for exactly the 20 authorized P0-002 articles,
...
def test_validator_passes():
    res = subprocess.run(
        [sys.executable, os.path.join(ROOT, "scripts",
                                      "validate_chinese_remediation_batch_p0_002.py")],
