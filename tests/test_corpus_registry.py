...
class TestRegistryStructure:
    ...
    def test_registry_version(self, registry):
        assert registry["registry_version"] == "2.5"
    ...
    def test_total_tracks(self, registry):
        assert registry["total_tracks"] == 26
    ...
    def test_total_primary_arabic(self, registry):
        assert registry["total_primary_arabic_governing_records"] == 3627
    ...
    def test_total_registry_counted(self, registry):
        assert registry["total_registry_counted_records"] == 4522
