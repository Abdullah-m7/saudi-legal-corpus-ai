...
def test_only_sections_1_2_3_files():
    ...
    assert files <= (need | {"book1_en_legal_llm.json", "book2_en_legal_llm.json", "book3_en_legal_llm.json", "book4_section4_en_legal_llm.json", "book4_section5_en_legal_llm.json"}), files
