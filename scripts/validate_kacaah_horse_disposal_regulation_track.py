#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the اللائحة التنظيمية للتصرف بالخيل المملوكة لمركز الملك عبدالعزيز للخيل العربية الأصيلة track.
...
RECORDS = os.path.join(ROOT, "sources", "kacaah_horse_disposal_regulation", "verified",
                       "kacaah_horse_disposal_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "kacaah_horse_disposal_regulation", "verified",
                       "kacaah_horse_disposal_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "kacaah_horse_disposal_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"kacaah_horse_disposal_regulation_no_decision_number_in_source", "kacaah_horse_disposal_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "اللائحة التنظيمية للتصرف بالخيل المملوكة لمركز الملك عبدالعزيز للخيل العربية الأصيلة":
    ...
    if e:
        print("FAIL: %d error(s) in Regulatory Rules for the Disposal of Horses Owned by the King Abdulaziz Arabian Horse Center track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Regulatory Rules for the Disposal of Horses Owned by the King Abdulaziz Arabian Horse Center")
