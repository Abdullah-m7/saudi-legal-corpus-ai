...
# -*- coding: utf-8 -*-
"""
English Legal LLM-ready layer — Book 3 (Limited Partnership, Articles 51-57).

Backfills the English Legal LLM layer for Book 3 — one `article_reference` record per
article, Articles 51-57. This complements the existing repo book4 English Legal LLM
...
record's `english_reference_text` in `data/english_reference/book3_en_reference.json`,
...
Reads : data/english_reference/book3_en_reference.json
Writes: data/english_legal_llm/book3_en_legal_llm.json
"""
...
BOOK = 3
ARTICLE_RANGE = list(range(51, 58))   # 51-57
SRC_REL = "data/english_reference/book3_en_reference.json"
OUT_REL = "data/english_legal_llm/book3_en_legal_llm.json"
...
def main():
    ...
    payload = {
        ...
        "scope": "book3_limited_partnership",
        "book": BOOK,
        "section_key": "limited_partnership",
        "section_title_en": "Limited Partnership",
        "article_range": "51-57",
