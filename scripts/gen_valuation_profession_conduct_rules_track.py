#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the قواعد سلوك مهنة التقييم وآدابها track.
...
SRC = os.path.join(ROOT, "sources", "valuation_profession_conduct_rules", "official_source",
                   "valuation_profession_conduct_rules_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "valuation_profession_conduct_rules", "verified")
...
def main():
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "valuation_profession_conduct_rules",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "VALUATION_PROFESSION_CONDUCT_RULES_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "valuation-profession-conduct-rules-llm-%03d" % idx,
            ...
            "article_path": "valuation_profession_conduct_rules/rules/%s" % key,
    ...
    json.dump({
        "law_key": "valuation_profession_conduct_rules",
        "layer": "VALUATION_PROFESSION_CONDUCT_RULES_ARABIC_VERIFIED_TEXT",
    ...
    print("Wrote %d verified + %d LLM-ready Code of Conduct and Ethics of the Valuation Profession records" % (len(ver), len(llm)))
