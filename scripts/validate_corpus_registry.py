...
def main() -> int:
    ...
    check("[3] 123 tracks present...", len(track_ids) == 123 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8425 records...", uix.get("total_records") == 8425,
    ...
    check("[19a] total_primary_arabic_governing_records == 8594...",
          registry.get("total_primary_arabic_governing_records") == 8594,
    ...
    check("[19e] total_registry_counted_records == 9489...",
          registry.get("total_registry_counted_records") == 9489,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 123 tracks (companies_law, "
              ...
              "Primary Arabic 8594, reference 614, registry-counted 9489. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8425) projects counted records. Read-only.")
    else:
