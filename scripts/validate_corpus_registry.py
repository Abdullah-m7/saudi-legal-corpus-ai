...
def main() -> int:
    ...
    check("[3] 122 tracks present...", len(track_ids) == 122 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8359 records...", uix.get("total_records") == 8359,
    ...
    check("[19a] total_primary_arabic_governing_records == 8528...",
          registry.get("total_primary_arabic_governing_records") == 8528,
    ...
    check("[19e] total_registry_counted_records == 9423...",
          registry.get("total_registry_counted_records") == 9423,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 122 tracks (companies_law, "
              ...
              "Primary Arabic 8528, reference 614, registry-counted 9423. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8359) projects counted records. Read-only.")
    else:
