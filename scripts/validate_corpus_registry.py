...
def main() -> int:
    ...
    check("[3] 138 tracks present...", len(track_ids) == 138 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9417 records...", uix.get("total_records") == 9417,
    ...
    check("[19a] total_primary_arabic_governing_records == 9586...",
          registry.get("total_primary_arabic_governing_records") == 9586,
    ...
    check("[19e] total_registry_counted_records == 10481...",
          registry.get("total_registry_counted_records") == 10481,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 138 tracks (companies_law, "
              ...
              "Primary Arabic 9586, reference 614, registry-counted 10481. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9417) projects counted records. Read-only.")
    else:
