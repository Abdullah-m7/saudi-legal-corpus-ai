...
def main() -> int:
    ...
    check("[3] 749 tracks present...", len(track_ids) == 749 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 25702 records...", uix.get("total_records") == 25702,
    ...
    check("[19a] total_primary_arabic_governing_records == 25871...",
          registry.get("total_primary_arabic_governing_records") == 25871,
    ...
    check("[19e] total_registry_counted_records == 26766...",
          registry.get("total_registry_counted_records") == 26766,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 749 tracks (companies_law, "
