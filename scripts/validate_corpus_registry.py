...
def main() -> int:
    ...
    check("[3] 69 tracks present...", len(track_ids) == 69 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6342 records...", uix.get("total_records") == 6342,
    ...
    check("[19a] total_primary_arabic_governing_records == 6511...",
          registry.get("total_primary_arabic_governing_records") == 6511,
    ...
    check("[19e] total_registry_counted_records == 7406...",
          registry.get("total_registry_counted_records") == 7406,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 69 tracks (companies_law, "
              ...
              "Primary Arabic 6511, reference 614, registry-counted 7406. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6342) projects counted records. Read-only.")
    else:
