...
def main() -> int:
    ...
    check("[3] 172 tracks present...", len(track_ids) == 172 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10606 records...", uix.get("total_records") == 10606,
    ...
    check("[19a] total_primary_arabic_governing_records == 10775...",
          registry.get("total_primary_arabic_governing_records") == 10775,
    ...
    check("[19e] total_registry_counted_records == 11670...",
          registry.get("total_registry_counted_records") == 11670,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 172 tracks (companies_law, "
