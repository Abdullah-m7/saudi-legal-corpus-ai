...
def main() -> int:
    ...
    check("[3] 92 tracks present...", len(track_ids) == 92 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6894 records...", uix.get("total_records") == 6894,
    ...
    check("[19a] total_primary_arabic_governing_records == 7063...",
          registry.get("total_primary_arabic_governing_records") == 7063,
    ...
    check("[19e] total_registry_counted_records == 7958...",
          registry.get("total_registry_counted_records") == 7958,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 92 tracks (companies_law, "
              ...
              "Primary Arabic 7063, reference 614, registry-counted 7958. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6894) projects counted records. Read-only.")
    else:
