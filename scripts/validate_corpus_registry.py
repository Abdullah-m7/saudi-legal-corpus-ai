...
def main() -> int:
    ...
    check("[3] 81 tracks present...", len(track_ids) == 81 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6607 records...", uix.get("total_records") == 6607,
    ...
    check("[19a] total_primary_arabic_governing_records == 6776...",
          registry.get("total_primary_arabic_governing_records") == 6776,
    ...
    check("[19e] total_registry_counted_records == 7671...",
          registry.get("total_registry_counted_records") == 7671,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 81 tracks (companies_law, "
              ...
              "Primary Arabic 6776, reference 614, registry-counted 7671. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6607) projects counted records. Read-only.")
    else:
