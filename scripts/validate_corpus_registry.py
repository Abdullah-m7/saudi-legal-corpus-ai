...
def main() -> int:
    ...
    check("[3] 86 tracks present...", len(track_ids) == 86 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6659 records...", uix.get("total_records") == 6659,
    ...
    check("[19a] total_primary_arabic_governing_records == 6828...",
          registry.get("total_primary_arabic_governing_records") == 6828,
    ...
    check("[19e] total_registry_counted_records == 7723...",
          registry.get("total_registry_counted_records") == 7723,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 86 tracks (companies_law, "
              ...
              "Primary Arabic 6828, reference 614, registry-counted 7723. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6659) projects counted records. Read-only.")
    else:
