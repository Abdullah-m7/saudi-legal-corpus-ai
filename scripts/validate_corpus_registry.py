...
def main() -> int:
    ...
    check("[3] 178 tracks present...", len(track_ids) == 178 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10857 records...", uix.get("total_records") == 10857,
    ...
    check("[19a] total_primary_arabic_governing_records == 11026...",
          registry.get("total_primary_arabic_governing_records") == 11026,
    ...
    check("[19e] total_registry_counted_records == 11921...",
          registry.get("total_registry_counted_records") == 11921,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 178 tracks (companies_law, "
