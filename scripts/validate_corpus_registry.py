...
def main() -> int:
    ...
    check("[3] 76 tracks present...", len(track_ids) == 76 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6537 records...", uix.get("total_records") == 6537,
    ...
    check("[19a] total_primary_arabic_governing_records == 6706...",
          registry.get("total_primary_arabic_governing_records") == 6706,
    ...
    check("[19e] total_registry_counted_records == 7601...",
          registry.get("total_registry_counted_records") == 7601,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 76 tracks (companies_law, "
              ...
              "Primary Arabic 6706, reference 614, registry-counted 7601. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6537) projects counted records. Read-only.")
    else:
