...
def main() -> int:
    ...
    check("[3] 133 tracks present...", len(track_ids) == 133 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9241 records...", uix.get("total_records") == 9241,
    ...
    check("[19a] total_primary_arabic_governing_records == 9410...",
          registry.get("total_primary_arabic_governing_records") == 9410,
    ...
    check("[19e] total_registry_counted_records == 10305...",
          registry.get("total_registry_counted_records") == 10305,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 133 tracks (companies_law, "
              ...
              "Primary Arabic 9410, reference 614, registry-counted 10305. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9241) projects counted records. Read-only.")
    else:
