...
def main() -> int:
    ...
    check("[3] 106 tracks present...", len(track_ids) == 106 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7316 records...", uix.get("total_records") == 7316,
    ...
    check("[19a] total_primary_arabic_governing_records == 7485...",
          registry.get("total_primary_arabic_governing_records") == 7485,
    ...
    check("[19e] total_registry_counted_records == 8380...",
          registry.get("total_registry_counted_records") == 8380,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 106 tracks (companies_law, "
              ...
              "Primary Arabic 7485, reference 614, registry-counted 8380. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7316) projects counted records. Read-only.")
    else:
