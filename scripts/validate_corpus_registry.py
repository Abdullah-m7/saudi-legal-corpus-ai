...
def main() -> int:
    ...
    check("[3] 102 tracks present...", len(track_ids) == 102 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7174 records...", uix.get("total_records") == 7174,
    ...
    check("[19a] total_primary_arabic_governing_records == 7343...",
          registry.get("total_primary_arabic_governing_records") == 7343,
    ...
    check("[19e] total_registry_counted_records == 8238...",
          registry.get("total_registry_counted_records") == 8238,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 102 tracks (companies_law, "
              ...
              "Primary Arabic 7343, reference 614, registry-counted 8238. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7174) projects counted records. Read-only.")
    else:
