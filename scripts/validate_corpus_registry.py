...
def main() -> int:
    ...
    check("[3] 101 tracks present...", len(track_ids) == 101 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7147 records...", uix.get("total_records") == 7147,
    ...
    check("[19a] total_primary_arabic_governing_records == 7316...",
          registry.get("total_primary_arabic_governing_records") == 7316,
    ...
    check("[19e] total_registry_counted_records == 8211...",
          registry.get("total_registry_counted_records") == 8211,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 101 tracks (companies_law, "
              ...
              "Primary Arabic 7316, reference 614, registry-counted 8211. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7147) projects counted records. Read-only.")
    else:
