...
def main() -> int:
    ...
    check("[3] 97 tracks present...", len(track_ids) == 97 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7023 records...", uix.get("total_records") == 7023,
    ...
    check("[19a] total_primary_arabic_governing_records == 7192...",
          registry.get("total_primary_arabic_governing_records") == 7192,
    ...
    check("[19e] total_registry_counted_records == 8087...",
          registry.get("total_registry_counted_records") == 8087,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 97 tracks (companies_law, "
              ...
              "Primary Arabic 7192, reference 614, registry-counted 8087. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7023) projects counted records. Read-only.")
    else:
