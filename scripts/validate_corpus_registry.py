...
def main() -> int:
    ...
    check("[3] 70 tracks present...", len(track_ids) == 70 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6389 records...", uix.get("total_records") == 6389,
    ...
    check("[19a] total_primary_arabic_governing_records == 6558...",
          registry.get("total_primary_arabic_governing_records") == 6558,
    ...
    check("[19e] total_registry_counted_records == 7453...",
          registry.get("total_registry_counted_records") == 7453,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 70 tracks (companies_law, "
              ...
              "Primary Arabic 6558, reference 614, registry-counted 7453. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6389) projects counted records. Read-only.")
    else:
