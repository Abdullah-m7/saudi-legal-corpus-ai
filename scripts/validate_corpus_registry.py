...
def main() -> int:
    ...
    check("[3] 131 tracks present...", len(track_ids) == 131 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9202 records...", uix.get("total_records") == 9202,
    ...
    check("[19a] total_primary_arabic_governing_records == 9371...",
          registry.get("total_primary_arabic_governing_records") == 9371,
    ...
    check("[19e] total_registry_counted_records == 10266...",
          registry.get("total_registry_counted_records") == 10266,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 131 tracks (companies_law, "
              ...
              "Primary Arabic 9371, reference 614, registry-counted 10266. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9202) projects counted records. Read-only.")
    else:
