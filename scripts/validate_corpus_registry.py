...
def main() -> int:
    ...
    check("[3] 155 tracks present...", len(track_ids) == 155 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10060 records...", uix.get("total_records") == 10060,
    ...
    check("[19a] total_primary_arabic_governing_records == 10229...",
          registry.get("total_primary_arabic_governing_records") == 10229,
    ...
    check("[19e] total_registry_counted_records == 11124...",
          registry.get("total_registry_counted_records") == 11124,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 155 tracks (companies_law, "
              ...
              "Primary Arabic 10229, reference 614, registry-counted 11124. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (10060) projects counted records. Read-only.")
    else:
