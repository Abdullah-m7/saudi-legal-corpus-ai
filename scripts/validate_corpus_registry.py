...
def main() -> int:
    ...
    check("[3] 75 tracks present...", len(track_ids) == 75 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6519 records...", uix.get("total_records") == 6519,
    ...
    check("[19a] total_primary_arabic_governing_records == 6688...",
          registry.get("total_primary_arabic_governing_records") == 6688,
    ...
    check("[19e] total_registry_counted_records == 7583...",
          registry.get("total_registry_counted_records") == 7583,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 75 tracks (companies_law, "
              ...
              "Primary Arabic 6688, reference 614, registry-counted 7583. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6519) projects counted records. Read-only.")
    else:
