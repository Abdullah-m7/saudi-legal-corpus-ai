...
def main() -> int:
    ...
    check("[3] 99 tracks present...", len(track_ids) == 99 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7078 records...", uix.get("total_records") == 7078,
    ...
    check("[19a] total_primary_arabic_governing_records == 7247...",
          registry.get("total_primary_arabic_governing_records") == 7247,
    ...
    check("[19e] total_registry_counted_records == 8142...",
          registry.get("total_registry_counted_records") == 8142,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 99 tracks (companies_law, "
              ...
              "Primary Arabic 7247, reference 614, registry-counted 8142. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7078) projects counted records. Read-only.")
    else:
