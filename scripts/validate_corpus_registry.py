...
def main() -> int:
    ...
    check("[3] 112 tracks present...", len(track_ids) == 112 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7556 records...", uix.get("total_records") == 7556,
    ...
    check("[19a] total_primary_arabic_governing_records == 7725...",
          registry.get("total_primary_arabic_governing_records") == 7725,
    ...
    check("[19e] total_registry_counted_records == 8620...",
          registry.get("total_registry_counted_records") == 8620,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 112 tracks (companies_law, "
              ...
              "Primary Arabic 7725, reference 614, registry-counted 8620. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7556) projects counted records. Read-only.")
    else:
