...
def main() -> int:
    ...
    check("[3] 296 tracks present...", len(track_ids) == 296 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 15807 records...", uix.get("total_records") == 15807,
    ...
    check("[19a] total_primary_arabic_governing_records == 15976...",
          registry.get("total_primary_arabic_governing_records") == 15976,
    ...
    check("[19e] total_registry_counted_records == 16871...",
          registry.get("total_registry_counted_records") == 16871,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 296 tracks (companies_law, "
