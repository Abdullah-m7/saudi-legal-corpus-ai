...
def main() -> int:
    ...
    check("[3] 118 tracks present...", len(track_ids) == 118 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8053 records...", uix.get("total_records") == 8053,
    ...
    check("[19a] total_primary_arabic_governing_records == 8222...",
          registry.get("total_primary_arabic_governing_records") == 8222,
    ...
    check("[19e] total_registry_counted_records == 9117...",
          registry.get("total_registry_counted_records") == 9117,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 118 tracks (companies_law, "
              ...
              "Primary Arabic 8222, reference 614, registry-counted 9117. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8053) projects counted records. Read-only.")
    else:
