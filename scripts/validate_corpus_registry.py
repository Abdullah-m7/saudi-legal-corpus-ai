...
def main() -> int:
    ...
    check("[3] 46 tracks present...", len(track_ids) == 46 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5509 records...", uix.get("total_records") == 5509,
    ...
    check("[19a] total_primary_arabic_governing_records == 5678...",
          registry.get("total_primary_arabic_governing_records") == 5678,
    ...
    check("[19e] total_registry_counted_records == 6573...",
          registry.get("total_registry_counted_records") == 6573,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 46 tracks (companies_law, "
              ...
              "Primary Arabic 5678, reference 614, registry-counted 6573. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (5509) projects counted records. Read-only.")
    else:
