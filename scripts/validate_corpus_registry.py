...
def main() -> int:
    ...
    check("[3] 130 tracks present...", len(track_ids) == 130 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8811 records...", uix.get("total_records") == 8811,
    ...
    check("[19a] total_primary_arabic_governing_records == 8980...",
          registry.get("total_primary_arabic_governing_records") == 8980,
    ...
    check("[19e] total_registry_counted_records == 9875...",
          registry.get("total_registry_counted_records") == 9875,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 130 tracks (companies_law, "
              ...
              "Primary Arabic 8980, reference 614, registry-counted 9875. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8811) projects counted records. Read-only.")
    else:
