...
def main() -> int:
    ...
    check("[3] 66 tracks present...", len(track_ids) == 66 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6189 records...", uix.get("total_records") == 6189,
    ...
    check("[19a] total_primary_arabic_governing_records == 6358...",
          registry.get("total_primary_arabic_governing_records") == 6358,
    ...
    check("[19e] total_registry_counted_records == 7253...",
          registry.get("total_registry_counted_records") == 7253,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 66 tracks (companies_law, "
              ...
              "Primary Arabic 6358, reference 614, registry-counted 7253. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6189) projects counted records. Read-only.")
    else:
