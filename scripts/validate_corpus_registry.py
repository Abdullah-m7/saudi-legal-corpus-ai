...
def main() -> int:
    ...
    check("[3] 44 tracks present...", len(track_ids) == 44 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5457 records...", uix.get("total_records") == 5457,
    ...
    check("[19a] total_primary_arabic_governing_records == 5626...",
          registry.get("total_primary_arabic_governing_records") == 5626,
    ...
    check("[19e] total_registry_counted_records == 6521...",
          registry.get("total_registry_counted_records") == 6521,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 44 tracks (companies_law, "
              ...
              "Primary Arabic 5626, reference 614, registry-counted 6521. All counts correct, all referenced paths "
