...
def main() -> int:
    ...
    check("[3] 158 tracks present...", len(track_ids) == 158 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10253 records...", uix.get("total_records") == 10253,
    ...
    check("[19a] total_primary_arabic_governing_records == 10422...",
          registry.get("total_primary_arabic_governing_records") == 10422,
    ...
    check("[19e] total_registry_counted_records == 11317...",
          registry.get("total_registry_counted_records") == 11317,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 158 tracks (companies_law, "
              ...
              "Primary Arabic 10422, reference 614, registry-counted 11317. All counts correct, all referenced paths "
