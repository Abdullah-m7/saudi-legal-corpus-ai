...
def main() -> int:
    ...
    check("[3] 132 tracks present...", len(track_ids) == 132 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9219 records...", uix.get("total_records") == 9219,
    ...
    check("[19a] total_primary_arabic_governing_records == 9388...",
          registry.get("total_primary_arabic_governing_records") == 9388,
    ...
    check("[19e] total_registry_counted_records == 10283...",
          registry.get("total_registry_counted_records") == 10283,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 132 tracks (companies_law, "
              ...
              "Primary Arabic 9388, reference 614, registry-counted 10283. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9219) projects counted records. Read-only.")
    else:
