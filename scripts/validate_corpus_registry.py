...
def main() -> int:
    ...
    check("[3] 87 tracks present...", len(track_ids) == 87 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6721 records...", uix.get("total_records") == 6721,
    ...
    check("[19a] total_primary_arabic_governing_records == 6890...",
          registry.get("total_primary_arabic_governing_records") == 6890,
    ...
    check("[19e] total_registry_counted_records == 7785...",
          registry.get("total_registry_counted_records") == 7785,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 87 tracks (companies_law, "
              ...
              "Primary Arabic 6890, reference 614, registry-counted 7785. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6721) projects counted records. Read-only.")
    else:
