...
def main() -> int:
    ...
    check("[3] 73 tracks present...", len(track_ids) == 73 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6476 records...", uix.get("total_records") == 6476,
    ...
    check("[19a] total_primary_arabic_governing_records == 6645...",
          registry.get("total_primary_arabic_governing_records") == 6645,
    ...
    check("[19e] total_registry_counted_records == 7540...",
          registry.get("total_registry_counted_records") == 7540,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 73 tracks (companies_law, "
              ...
              "Primary Arabic 6645, reference 614, registry-counted 7540. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6476) projects counted records. Read-only.")
    else:
