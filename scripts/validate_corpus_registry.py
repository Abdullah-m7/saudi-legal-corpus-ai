...
def main() -> int:
    ...
    check("[3] 59 tracks present...", len(track_ids) == 59 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5978 records...", uix.get("total_records") == 5978,
    ...
    check("[19a] total_primary_arabic_governing_records == 6147...",
          registry.get("total_primary_arabic_governing_records") == 6147,
    ...
    check("[19e] total_registry_counted_records == 7042...",
          registry.get("total_registry_counted_records") == 7042,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 59 tracks (companies_law, "
              ...
              "Primary Arabic 6147, reference 614, registry-counted 7042. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (5978) projects counted records. Read-only.")
    else:
