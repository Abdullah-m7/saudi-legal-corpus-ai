...
def main() -> int:
    ...
    check("[3] 109 tracks present...", len(track_ids) == 109 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7452 records...", uix.get("total_records") == 7452,
    ...
    check("[19a] total_primary_arabic_governing_records == 7621...",
          registry.get("total_primary_arabic_governing_records") == 7621,
    ...
    check("[19e] total_registry_counted_records == 8516...",
          registry.get("total_registry_counted_records") == 8516,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 109 tracks (companies_law, "
              ...
              "Primary Arabic 7621, reference 614, registry-counted 8516. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7452) projects counted records. Read-only.")
    else:
