...
def main() -> int:
    ...
    check("[3] 134 tracks present...", len(track_ids) == 134 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9265 records...", uix.get("total_records") == 9265,
    ...
    check("[19a] total_primary_arabic_governing_records == 9434...",
          registry.get("total_primary_arabic_governing_records") == 9434,
    ...
    check("[19e] total_registry_counted_records == 10329...",
          registry.get("total_registry_counted_records") == 10329,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 134 tracks (companies_law, "
              ...
              "Primary Arabic 9434, reference 614, registry-counted 10329. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9265) projects counted records. Read-only.")
    else:
