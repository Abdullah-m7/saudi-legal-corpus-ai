...
def main() -> int:
    ...
    check("[3] 93 tracks present...", len(track_ids) == 93 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6902 records...", uix.get("total_records") == 6902,
    ...
    check("[19a] total_primary_arabic_governing_records == 7071...",
          registry.get("total_primary_arabic_governing_records") == 7071,
    ...
    check("[19e] total_registry_counted_records == 7966...",
          registry.get("total_registry_counted_records") == 7966,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 93 tracks (companies_law, "
              ...
              "Primary Arabic 7071, reference 614, registry-counted 7966. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6902) projects counted records. Read-only.")
    else:
