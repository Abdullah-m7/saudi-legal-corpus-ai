...
def main() -> int:
    ...
    check("[3] 34 tracks present...", len(track_ids) == 34 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 4489 records...", uix.get("total_records") == 4489,
    ...
    check("[19a] total_primary_arabic_governing_records == 4658...",
          registry.get("total_primary_arabic_governing_records") == 4658,
    ...
    check("[19e] total_registry_counted_records == 5553...",
          registry.get("total_registry_counted_records") == 5553,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 34 tracks (companies_law, "
              ...
              "Primary Arabic 4658, reference 614, registry-counted 5553. All counts correct, all referenced paths "
              ...
              "1446H Active issuance all اصلية, superseding the InActive 1423H one). "
              "Unified retrieval index (4489) projects counted records. Read-only.")
    else:
