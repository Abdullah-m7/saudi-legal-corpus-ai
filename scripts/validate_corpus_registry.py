...
def main() -> int:
    ...
    check("[3] 56 tracks present...", len(track_ids) == 56 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5889 records...", uix.get("total_records") == 5889,
    ...
    check("[19a] total_primary_arabic_governing_records == 6058...",
          registry.get("total_primary_arabic_governing_records") == 6058,
    ...
    check("[19e] total_registry_counted_records == 6953...",
          registry.get("total_registry_counted_records") == 6953,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 56 tracks (companies_law, "
              ...
              "Primary Arabic 6058, reference 614, registry-counted 6953. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (5889) projects counted records. Read-only.")
    else:
