...
def main() -> int:
    ...
    check("[3] 126 tracks present...", len(track_ids) == 126 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8679 records...", uix.get("total_records") == 8679,
    ...
    check("[19a] total_primary_arabic_governing_records == 8848...",
          registry.get("total_primary_arabic_governing_records") == 8848,
    ...
    check("[19e] total_registry_counted_records == 9743...",
          registry.get("total_registry_counted_records") == 9743,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 126 tracks (companies_law, "
              ...
              "Primary Arabic 8848, reference 614, registry-counted 9743. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8679) projects counted records. Read-only.")
    else:
