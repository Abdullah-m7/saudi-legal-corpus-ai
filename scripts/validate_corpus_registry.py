...
def main() -> int:
    ...
    check("[3] 90 tracks present...", len(track_ids) == 90 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6795 records...", uix.get("total_records") == 6795,
    ...
    check("[19a] total_primary_arabic_governing_records == 6964...",
          registry.get("total_primary_arabic_governing_records") == 6964,
    ...
    check("[19e] total_registry_counted_records == 7859...",
          registry.get("total_registry_counted_records") == 7859,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 90 tracks (companies_law, "
              ...
              "Primary Arabic 6964, reference 614, registry-counted 7859. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6795) projects counted records. Read-only.")
    else:
