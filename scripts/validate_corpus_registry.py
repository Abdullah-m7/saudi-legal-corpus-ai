...
def main() -> int:
    ...
    check("[3] 62 tracks present...", len(track_ids) == 62 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6025 records...", uix.get("total_records") == 6025,
    ...
    check("[19a] total_primary_arabic_governing_records == 6194...",
          registry.get("total_primary_arabic_governing_records") == 6194,
    ...
    check("[19e] total_registry_counted_records == 7089...",
          registry.get("total_registry_counted_records") == 7089,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 62 tracks (companies_law, "
              ...
              "Primary Arabic 6194, reference 614, registry-counted 7089. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6025) projects counted records. Read-only.")
    else:
