...
def main() -> int:
    ...
    check("[3] 96 tracks present...", len(track_ids) == 96 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6992 records...", uix.get("total_records") == 6992,
    ...
    check("[19a] total_primary_arabic_governing_records == 7161...",
          registry.get("total_primary_arabic_governing_records") == 7161,
    ...
    check("[19e] total_registry_counted_records == 8056...",
          registry.get("total_registry_counted_records") == 8056,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 96 tracks (companies_law, "
              ...
              "Primary Arabic 7161, reference 614, registry-counted 8056. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6992) projects counted records. Read-only.")
    else:
