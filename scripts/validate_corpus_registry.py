...
def main() -> int:
    ...
    check("[3] 149 tracks present...", len(track_ids) == 149 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9777 records...", uix.get("total_records") == 9777,
    ...
    check("[19a] total_primary_arabic_governing_records == 9946...",
          registry.get("total_primary_arabic_governing_records") == 9946,
    ...
    check("[19e] total_registry_counted_records == 10841...",
          registry.get("total_registry_counted_records") == 10841,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 149 tracks (companies_law, "
              ...
              "Primary Arabic 9946, reference 614, registry-counted 10841. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9777) projects counted records. Read-only.")
    else:
