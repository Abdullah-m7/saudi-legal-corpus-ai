...
def main() -> int:
    ...
    check("[3] 89 tracks present...", len(track_ids) == 89 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6770 records...", uix.get("total_records") == 6770,
    ...
    check("[19a] total_primary_arabic_governing_records == 6939...",
          registry.get("total_primary_arabic_governing_records") == 6939,
    ...
    check("[19e] total_registry_counted_records == 7834...",
          registry.get("total_registry_counted_records") == 7834,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 89 tracks (companies_law, "
              ...
              "Primary Arabic 6939, reference 614, registry-counted 7834. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6770) projects counted records. Read-only.")
    else:
