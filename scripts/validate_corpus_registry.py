...
def main() -> int:
    ...
    check("[3] 128 tracks present...", len(track_ids) == 128 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8739 records...", uix.get("total_records") == 8739,
    ...
    check("[19a] total_primary_arabic_governing_records == 8908...",
          registry.get("total_primary_arabic_governing_records") == 8908,
    ...
    check("[19e] total_registry_counted_records == 9803...",
          registry.get("total_registry_counted_records") == 9803,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 128 tracks (companies_law, "
              ...
              "Primary Arabic 8908, reference 614, registry-counted 9803. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8739) projects counted records. Read-only.")
    else:
