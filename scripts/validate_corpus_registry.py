...
def main() -> int:
    ...
    check("[3] 129 tracks present...", len(track_ids) == 129 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8783 records...", uix.get("total_records") == 8783,
    ...
    check("[19a] total_primary_arabic_governing_records == 8952...",
          registry.get("total_primary_arabic_governing_records") == 8952,
    ...
    check("[19e] total_registry_counted_records == 9847...",
          registry.get("total_registry_counted_records") == 9847,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 129 tracks (companies_law, "
              ...
              "Primary Arabic 8952, reference 614, registry-counted 9847. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8783) projects counted records. Read-only.")
    else:
