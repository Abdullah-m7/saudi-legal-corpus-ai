...
def main() -> int:
    ...
    check("[3] 67 tracks present...", len(track_ids) == 67 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6226 records...", uix.get("total_records") == 6226,
    ...
    check("[19a] total_primary_arabic_governing_records == 6395...",
          registry.get("total_primary_arabic_governing_records") == 6395,
    ...
    check("[19e] total_registry_counted_records == 7290...",
          registry.get("total_registry_counted_records") == 7290,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 67 tracks (companies_law, "
              ...
              "Primary Arabic 6395, reference 614, registry-counted 7290. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6226) projects counted records. Read-only.")
    else:
