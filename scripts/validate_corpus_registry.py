...
def main() -> int:
    ...
    check("[3] 100 tracks present...", len(track_ids) == 100 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7106 records...", uix.get("total_records") == 7106,
    ...
    check("[19a] total_primary_arabic_governing_records == 7275...",
          registry.get("total_primary_arabic_governing_records") == 7275,
    ...
    check("[19e] total_registry_counted_records == 8170...",
          registry.get("total_registry_counted_records") == 8170,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 100 tracks (companies_law, "
              ...
              "Primary Arabic 7275, reference 614, registry-counted 8170. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7106) projects counted records. Read-only.")
    else:
