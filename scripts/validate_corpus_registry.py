...
def main() -> int:
    ...
    check("[3] 74 tracks present...", len(track_ids) == 74 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6499 records...", uix.get("total_records") == 6499,
    ...
    check("[19a] total_primary_arabic_governing_records == 6668...",
          registry.get("total_primary_arabic_governing_records") == 6668,
    ...
    check("[19e] total_registry_counted_records == 7563...",
          registry.get("total_registry_counted_records") == 7563,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 74 tracks (companies_law, "
              ...
              "Primary Arabic 6668, reference 614, registry-counted 7563. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6499) projects counted records. Read-only.")
    else:
