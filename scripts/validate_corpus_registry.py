...
def main() -> int:
    ...
    check("[3] 136 tracks present...", len(track_ids) == 136 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9299 records...", uix.get("total_records") == 9299,
    ...
    check("[19a] total_primary_arabic_governing_records == 9468...",
          registry.get("total_primary_arabic_governing_records") == 9468,
    ...
    check("[19e] total_registry_counted_records == 10363...",
          registry.get("total_registry_counted_records") == 10363,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 136 tracks (companies_law, "
              ...
              "Primary Arabic 9468, reference 614, registry-counted 10363. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9299) projects counted records. Read-only.")
    else:
