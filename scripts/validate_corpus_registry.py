...
def main() -> int:
    ...
    check("[3] 135 tracks present...", len(track_ids) == 135 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9290 records...", uix.get("total_records") == 9290,
    ...
    check("[19a] total_primary_arabic_governing_records == 9459...",
          registry.get("total_primary_arabic_governing_records") == 9459,
    ...
    check("[19e] total_registry_counted_records == 10354...",
          registry.get("total_registry_counted_records") == 10354,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 135 tracks (companies_law, "
              ...
              "Primary Arabic 9459, reference 614, registry-counted 10354. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9290) projects counted records. Read-only.")
    else:
