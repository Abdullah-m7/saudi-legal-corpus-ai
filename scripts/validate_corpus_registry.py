...
def main() -> int:
    ...
    check("[3] 58 tracks present...", len(track_ids) == 58 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5963 records...", uix.get("total_records") == 5963,
    ...
    check("[19a] total_primary_arabic_governing_records == 6132...",
          registry.get("total_primary_arabic_governing_records") == 6132,
    ...
    check("[19e] total_registry_counted_records == 7027...",
          registry.get("total_registry_counted_records") == 7027,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 58 tracks (companies_law, "
              ...
              "Primary Arabic 6132, reference 614, registry-counted 7027. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (5963) projects counted records. Read-only.")
    else:
