...
def main() -> int:
    ...
    check("[3] 127 tracks present...", len(track_ids) == 127 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8720 records...", uix.get("total_records") == 8720,
    ...
    check("[19a] total_primary_arabic_governing_records == 8889...",
          registry.get("total_primary_arabic_governing_records") == 8889,
    ...
    check("[19e] total_registry_counted_records == 9784...",
          registry.get("total_registry_counted_records") == 9784,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 127 tracks (companies_law, "
              ...
              "Primary Arabic 8889, reference 614, registry-counted 9784. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8720) projects counted records. Read-only.")
    else:
