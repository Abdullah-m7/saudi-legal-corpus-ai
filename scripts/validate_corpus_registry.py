...
def main() -> int:
    ...
    check("[3] 98 tracks present...", len(track_ids) == 98 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7048 records...", uix.get("total_records") == 7048,
    ...
    check("[19a] total_primary_arabic_governing_records == 7217...",
          registry.get("total_primary_arabic_governing_records") == 7217,
    ...
    check("[19e] total_registry_counted_records == 8112...",
          registry.get("total_registry_counted_records") == 8112,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 98 tracks (companies_law, "
              ...
              "Primary Arabic 7217, reference 614, registry-counted 8112. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7048) projects counted records. Read-only.")
    else:
