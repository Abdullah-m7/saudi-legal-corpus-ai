...
def main() -> int:
    ...
    check("[3] 156 tracks present...", len(track_ids) == 156 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10142 records...", uix.get("total_records") == 10142,
    ...
    check("[19a] total_primary_arabic_governing_records == 10311...",
          registry.get("total_primary_arabic_governing_records") == 10311,
    ...
    check("[19e] total_registry_counted_records == 11206...",
          registry.get("total_registry_counted_records") == 11206,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 156 tracks (companies_law, "
              ...
              "Primary Arabic 10311, reference 614, registry-counted 11206. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (10142) projects counted records. Read-only.")
    else:
