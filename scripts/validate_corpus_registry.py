...
def main() -> int:
    ...
    check("[3] 68 tracks present...", len(track_ids) == 68 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6294 records...", uix.get("total_records") == 6294,
    ...
    check("[19a] total_primary_arabic_governing_records == 6463...",
          registry.get("total_primary_arabic_governing_records") == 6463,
    ...
    check("[19e] total_registry_counted_records == 7358...",
          registry.get("total_registry_counted_records") == 7358,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 68 tracks (companies_law, "
              ...
              "Primary Arabic 6463, reference 614, registry-counted 7358. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6294) projects counted records. Read-only.")
    else:
