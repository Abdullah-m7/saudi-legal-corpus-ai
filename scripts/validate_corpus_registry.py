...
def main() -> int:
    ...
    check("[3] 157 tracks present...", len(track_ids) == 157 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 10216 records...", uix.get("total_records") == 10216,
    ...
    check("[19a] total_primary_arabic_governing_records == 10385...",
          registry.get("total_primary_arabic_governing_records") == 10385,
    ...
    check("[19e] total_registry_counted_records == 11280...",
          registry.get("total_registry_counted_records") == 11280,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 157 tracks (companies_law, "
              ...
              "Primary Arabic 10385, reference 614, registry-counted 11280. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (10216) projects counted records. Read-only.")
    else:
