...
def main() -> int:
    ...
    check("[3] 71 tracks present...", len(track_ids) == 71 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6424 records...", uix.get("total_records") == 6424,
    ...
    check("[19a] total_primary_arabic_governing_records == 6593...",
          registry.get("total_primary_arabic_governing_records") == 6593,
    ...
    check("[19e] total_registry_counted_records == 7488...",
          registry.get("total_registry_counted_records") == 7488,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 71 tracks (companies_law, "
              ...
              "Primary Arabic 6593, reference 614, registry-counted 7488. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6424) projects counted records. Read-only.")
    else:
