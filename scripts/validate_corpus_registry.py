...
def main() -> int:
    ...
    check("[3] 125 tracks present...", len(track_ids) == 125 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8649 records...", uix.get("total_records") == 8649,
    ...
    check("[19a] total_primary_arabic_governing_records == 8818...",
          registry.get("total_primary_arabic_governing_records") == 8818,
    ...
    check("[19e] total_registry_counted_records == 9713...",
          registry.get("total_registry_counted_records") == 9713,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 125 tracks (companies_law, "
              ...
              "Primary Arabic 8818, reference 614, registry-counted 9713. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8649) projects counted records. Read-only.")
    else:
