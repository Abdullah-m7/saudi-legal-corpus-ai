...
def main() -> int:
    ...
    check("[3] 110 tracks present...", len(track_ids) == 110 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7477 records...", uix.get("total_records") == 7477,
    ...
    check("[19a] total_primary_arabic_governing_records == 7646...",
          registry.get("total_primary_arabic_governing_records") == 7646,
    ...
    check("[19e] total_registry_counted_records == 8541...",
          registry.get("total_registry_counted_records") == 8541,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 110 tracks (companies_law, "
              ...
              "Primary Arabic 7646, reference 614, registry-counted 8541. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7477) projects counted records. Read-only.")
    else:
