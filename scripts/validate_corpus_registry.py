...
def main() -> int:
    ...
    check("[3] 57 tracks present...", len(track_ids) == 57 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 5922 records...", uix.get("total_records") == 5922,
    ...
    check("[19a] total_primary_arabic_governing_records == 6091...",
          registry.get("total_primary_arabic_governing_records") == 6091,
    ...
    check("[19e] total_registry_counted_records == 6986...",
          registry.get("total_registry_counted_records") == 6986,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 57 tracks (companies_law, "
              ...
              "Primary Arabic 6091, reference 614, registry-counted 6986. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (5922) projects counted records. Read-only.")
    else:
