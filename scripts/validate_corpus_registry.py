...
def main() -> int:
    ...
    check("[3] 105 tracks present...", len(track_ids) == 105 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7296 records...", uix.get("total_records") == 7296,
    ...
    check("[19a] total_primary_arabic_governing_records == 7465...",
          registry.get("total_primary_arabic_governing_records") == 7465,
    ...
    check("[19e] total_registry_counted_records == 8360...",
          registry.get("total_registry_counted_records") == 8360,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 105 tracks (companies_law, "
              ...
              "Primary Arabic 7465, reference 614, registry-counted 8360. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7296) projects counted records. Read-only.")
    else:
