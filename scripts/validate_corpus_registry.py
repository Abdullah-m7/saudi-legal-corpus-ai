...
def main() -> int:
    ...
    check("[3] 295 tracks present...", len(track_ids) == 295 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 15794 records...", uix.get("total_records") == 15794,
    ...
    check("[19a] total_primary_arabic_governing_records == 15963...",
          registry.get("total_primary_arabic_governing_records") == 15963,
    ...
    check("[19e] total_registry_counted_records == 16858...",
          registry.get("total_registry_counted_records") == 16858,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 295 tracks (companies_law, "
