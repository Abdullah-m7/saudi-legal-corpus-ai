...
def main() -> int:
    ...
    check("[3] 152 tracks present...", len(track_ids) == 152 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9875 records...", uix.get("total_records") == 9875,
    ...
    check("[19a] total_primary_arabic_governing_records == 10044...",
          registry.get("total_primary_arabic_governing_records") == 10044,
    ...
    check("[19e] total_registry_counted_records == 10939...",
          registry.get("total_registry_counted_records") == 10939,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 152 tracks (companies_law, "
              ...
              "Primary Arabic 10044, reference 614, registry-counted 10939. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9875) projects counted records. Read-only.")
    else:
