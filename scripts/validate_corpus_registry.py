...
def main() -> int:
    ...
    check("[3] 121 tracks present...", len(track_ids) == 121 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8231 records...", uix.get("total_records") == 8231,
    ...
    check("[19a] total_primary_arabic_governing_records == 8400...",
          registry.get("total_primary_arabic_governing_records") == 8400,
    ...
    check("[19e] total_registry_counted_records == 9295...",
          registry.get("total_registry_counted_records") == 9295,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 121 tracks (companies_law, "
              ...
              "Primary Arabic 8400, reference 614, registry-counted 9295. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8231) projects counted records. Read-only.")
    else:
