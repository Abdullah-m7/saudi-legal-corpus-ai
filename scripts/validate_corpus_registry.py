...
def main() -> int:
    ...
    check("[3] 120 tracks present...", len(track_ids) == 120 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 8160 records...", uix.get("total_records") == 8160,
    ...
    check("[19a] total_primary_arabic_governing_records == 8329...",
          registry.get("total_primary_arabic_governing_records") == 8329,
    ...
    check("[19e] total_registry_counted_records == 9224...",
          registry.get("total_registry_counted_records") == 9224,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 120 tracks (companies_law, "
              ...
              "Primary Arabic 8329, reference 614, registry-counted 9224. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (8160) projects counted records. Read-only.")
    else:
