...
def main() -> int:
    ...
    check("[3] 108 tracks present...", len(track_ids) == 108 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7432 records...", uix.get("total_records") == 7432,
    ...
    check("[19a] total_primary_arabic_governing_records == 7601...",
          registry.get("total_primary_arabic_governing_records") == 7601,
    ...
    check("[19e] total_registry_counted_records == 8496...",
          registry.get("total_registry_counted_records") == 8496,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 108 tracks (companies_law, "
              ...
              "Primary Arabic 7601, reference 614, registry-counted 8496. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7432) projects counted records. Read-only.")
    else:
