...
def main() -> int:
    ...
    check("[3] 72 tracks present...", len(track_ids) == 72 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6453 records...", uix.get("total_records") == 6453,
    ...
    check("[19a] total_primary_arabic_governing_records == 6622...",
          registry.get("total_primary_arabic_governing_records") == 6622,
    ...
    check("[19e] total_registry_counted_records == 7517...",
          registry.get("total_registry_counted_records") == 7517,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 72 tracks (companies_law, "
              ...
              "Primary Arabic 6622, reference 614, registry-counted 7517. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6453) projects counted records. Read-only.")
    else:
