...
def main() -> int:
    ...
    check("[3] 91 tracks present...", len(track_ids) == 91 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6878 records...", uix.get("total_records") == 6878,
    ...
    check("[19a] total_primary_arabic_governing_records == 7047...",
          registry.get("total_primary_arabic_governing_records") == 7047,
    ...
    check("[19e] total_registry_counted_records == 7942...",
          registry.get("total_registry_counted_records") == 7942,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 91 tracks (companies_law, "
              ...
              "Primary Arabic 7047, reference 614, registry-counted 7942. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6878) projects counted records. Read-only.")
    else:
