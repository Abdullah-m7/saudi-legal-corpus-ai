...
def main() -> int:
    ...
    check("[3] 137 tracks present...", len(track_ids) == 137 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9368 records...", uix.get("total_records") == 9368,
    ...
    check("[19a] total_primary_arabic_governing_records == 9537...",
          registry.get("total_primary_arabic_governing_records") == 9537,
    ...
    check("[19e] total_registry_counted_records == 10432...",
          registry.get("total_registry_counted_records") == 10432,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 137 tracks (companies_law, "
              ...
              "Primary Arabic 9537, reference 614, registry-counted 10432. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9368) projects counted records. Read-only.")
    else:
