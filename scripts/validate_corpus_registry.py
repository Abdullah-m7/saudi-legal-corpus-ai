...
def main() -> int:
    ...
    check("[3] 139 tracks present...", len(track_ids) == 139 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9434 records...", uix.get("total_records") == 9434,
    ...
    check("[19a] total_primary_arabic_governing_records == 9603...",
          registry.get("total_primary_arabic_governing_records") == 9603,
    ...
    check("[19e] total_registry_counted_records == 10498...",
          registry.get("total_registry_counted_records") == 10498,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 139 tracks (companies_law, "
              ...
              "Primary Arabic 9603, reference 614, registry-counted 10498. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9434) projects counted records. Read-only.")
    else:
