...
def main() -> int:
    ...
    check("[7g] unified retrieval index: 15820 records...", uix.get("total_records") == 15820,
    ...
    check("[19a] total_primary_arabic_governing_records == 15989...",
          registry.get("total_primary_arabic_governing_records") == 15989,
    ...
    check("[19e] total_registry_counted_records == 16884...",
          registry.get("total_registry_counted_records") == 16884,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 297 tracks (companies_law, "
