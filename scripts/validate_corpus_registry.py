...
def main() -> int:
    ...
    check("[3] 294 tracks present...", len(track_ids) == 294 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 15758 records...", uix.get("total_records") == 15758,
    ...
    check("[19a] total_primary_arabic_governing_records == 15927...",
          registry.get("total_primary_arabic_governing_records") == 15927,
    ...
    check("[19e] total_registry_counted_records == 16822...",
          registry.get("total_registry_counted_records") == 16822,
