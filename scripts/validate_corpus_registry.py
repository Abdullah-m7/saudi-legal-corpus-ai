...
def main() -> int:
    ...
    check("[3] 148 tracks present...", len(track_ids) == 148 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 9763 records...", uix.get("total_records") == 9763,
    ...
    check("[19a] total_primary_arabic_governing_records == 9932...",
          registry.get("total_primary_arabic_governing_records") == 9932,
    ...
    check("[19e] total_registry_counted_records == 10827...",
          registry.get("total_registry_counted_records") == 10827,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 148 tracks (companies_law, "
              ...
              "Primary Arabic 9932, reference 614, registry-counted 10827. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (9763) projects counted records. Read-only.")
    else:
