...
def main() -> int:
    ...
    check("[3] 111 tracks present...", len(track_ids) == 111 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 7503 records...", uix.get("total_records") == 7503,
    ...
    check("[19a] total_primary_arabic_governing_records == 7672...",
          registry.get("total_primary_arabic_governing_records") == 7672,
    ...
    check("[19e] total_registry_counted_records == 8567...",
          registry.get("total_registry_counted_records") == 8567,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 111 tracks (companies_law, "
              ...
              "Primary Arabic 7672, reference 614, registry-counted 8567. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (7503) projects counted records. Read-only.")
    else:
