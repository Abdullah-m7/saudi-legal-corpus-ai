...
def main() -> int:
    ...
    check("[3] 88 tracks present...", len(track_ids) == 88 and all(tid in track_ids for tid in REQUIRED_TRACK_IDS),
          f"Tracks: {track_ids}")
    ...
    check("[7g] unified retrieval index: 6760 records...", uix.get("total_records") == 6760,
    ...
    check("[19a] total_primary_arabic_governing_records == 6929...",
          registry.get("total_primary_arabic_governing_records") == 6929,
    ...
    check("[19e] total_registry_counted_records == 7824...",
          registry.get("total_registry_counted_records") == 7824,
...
def print_results() -> None:
    ...
    if FAILED == 0:
        ...
        print("[PASS] Corpus Registry Index Foundation: 88 tracks (companies_law, "
              ...
              "Primary Arabic 6929, reference 614, registry-counted 7824. All counts correct, all referenced paths "
              ...
              "Unified retrieval index (6760) projects counted records. Read-only.")
    else:
