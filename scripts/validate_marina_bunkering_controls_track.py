#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the الضوابط والإجراءات لعمليات التزود بالوقود في المراسي البحرية السياحيةقرار مجلس إدارة الهيئة السعودية للبحر الأحمر رقم (1ت-2-2024) وتاريخ 15 /01 /1446ه track.
...
RECORDS = os.path.join(ROOT, "sources", "marina_bunkering_controls", "verified",
                       "marina_bunkering_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "marina_bunkering_controls", "verified",
                       "marina_bunkering_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "marina_bunkering_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"marina_bunkering_controls_no_decision_number_in_source", "marina_bunkering_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "الضوابط والإجراءات لعمليات التزود بالوقود في المراسي البحرية السياحيةقرار مجلس إدارة الهيئة السعودية للبحر الأحمر رقم (1ت-2-2024) وتاريخ 15 /01 /1446ه":
    ...
    if e:
        print("FAIL: %d error(s) in Controls and Procedures for Bunkering Operations at Tourist Marinas track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls and Procedures for Bunkering Operations at Tourist Marinas")
