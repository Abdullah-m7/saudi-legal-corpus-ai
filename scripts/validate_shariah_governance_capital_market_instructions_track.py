#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the تعليمات الحوكمة الشرعية في مؤسسات السوق المالية track.
...
RECORDS = os.path.join(ROOT, "sources", "shariah_governance_capital_market_instructions", "verified",
                       "shariah_governance_capital_market_instructions_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "shariah_governance_capital_market_instructions", "verified",
                       "shariah_governance_capital_market_instructions_verified_summary.json")
LLM = os.path.join(ROOT, "data", "shariah_governance_capital_market_instructions_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"shariah_governance_capital_market_instructions_no_decision_number_in_source", "shariah_governance_capital_market_instructions_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "تعليمات الحوكمة الشرعية في مؤسسات السوق المالية":
    ...
    if e:
        print("FAIL: %d error(s) in Shariah Governance Instructions for Capital Market Institutions track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Shariah Governance Instructions for Capital Market Institutions")
