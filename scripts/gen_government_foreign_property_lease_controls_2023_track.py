#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the ضوابط استئجار الجهات الحكومية للعقارات خارج المملكة track.
...
server-rendered HTML page (uqn.gov.sa/details?p=21469),
published 26/7/1444H (2023-02-17). The Gazette IS the official publication of record
...
SRC = os.path.join(ROOT, "sources", "government_foreign_property_lease_controls_2023", "official_source",
                   "government_foreign_property_lease_controls_2023_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "government_foreign_property_lease_controls_2023", "verified")
RECORDS = os.path.join(OUT_VER, "government_foreign_property_lease_controls_2023_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "government_foreign_property_lease_controls_2023_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "government_foreign_property_lease_controls_2023_arabic_legal_llm",
                        "government_foreign_property_lease_controls_2023_legal_llm_001_012.json")

LAW_ID = "sa-government-foreign-property-lease-controls-2023"
LAW_AR = "ضوابط استئجار الجهات الحكومية للعقارات خارج المملكة"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"government_foreign_property_lease_controls_2023_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=21469), published 26/7/1444H (2023-02-17). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "government_foreign_property_lease_controls_2023",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "GOVERNMENT_FOREIGN_PROPERTY_LEASE_CONTROLS_2023_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "government-foreign-property-lease-controls-2023-llm-%03d" % idx,
            ...
            "article_path": "government_foreign_property_lease_controls_2023/rules/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Controls on the Leasing of Real Estate Abroad by Government Entities (2023) -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 26/7/1444H / 2023-02-17)"),
                "source_authority_ar": ("ضوابط استئجار الجهات الحكومية للعقارات خارج المملكة — النص الكامل جُلب مباشرة من صفحة جريدة أم "
                                        "القرى الرسمية (تاريخ النشر 26/7/1444هـ الموافق 2023-02-17م)"),
    ...
    json.dump({
        "law_key": "government_foreign_property_lease_controls_2023",
        "layer": "GOVERNMENT_FOREIGN_PROPERTY_LEASE_CONTROLS_2023_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "government-foreign-property-lease-controls-2023-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (12 مادة، جميعها أصلية)",
        "title_en": "Controls on the Leasing of Real Estate Abroad by Government Entities (2023) — Arabic LLM-ready layer (12 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Controls on the Leasing of Real Estate Abroad by Government Entities (2023) records" % (len(ver), len(llm)))
