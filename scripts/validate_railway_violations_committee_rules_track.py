...
RECORDS = os.path.join(ROOT, "sources", "railway_violations_committee_rules", "verified",
                       "railway_violations_committee_rules_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "railway_violations_committee_rules", "verified",
                       "railway_violations_committee_rules_verified_summary.json")
LLM = os.path.join(ROOT, "data", "railway_violations_committee_rules_arabic_legal_llm",
