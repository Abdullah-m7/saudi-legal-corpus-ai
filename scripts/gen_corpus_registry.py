...
def main() -> int:
    ...
    registry: dict[str, Any] = {
        ...
        "total_registry_counted_records": (
            ...
            + enforcement_law_llm["record_count"]
        ...
        "count_policy": {
            ...
            "formula_total_registry_counted": "total_primary_arabic_governing(4128) + total_reference(614) + total_internal_reference(281) = 5023",
