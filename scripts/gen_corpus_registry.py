...
def main() -> int:
    ...
    registry: dict[str, Any] = {
        ...
        "count_policy": {
            ...
            "formula_total_registry_counted": "total_primary_arabic_governing(7047) + total_reference(614) + total_internal_reference(281) = 7942",
