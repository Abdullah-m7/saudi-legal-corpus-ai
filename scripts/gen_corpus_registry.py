    ...
    registry: dict[str, Any] = {
        ...
        "tracks": [
            ...
            },
            {
                ...
                "governing_language": "ar",
                "status": "complete",
                "official_text_status": "BOE_PORTAL_PRIMARY_SOURCE_WIPO_LEX_SPOT_CHECKED",
                "source_authority": "Royal Order / أمر ملكي (أ/90) — Bureau of Experts (BOE) portal, primary structured source, cross-checked against WIPO Lex (spot-checked; see notes)",
                "language_layers": {"arabic": {"status": "complete", "governing": True,
                ...
                "record_counts": {"arabic_articles": basic_law_of_governance_llm["record_count"],
                                  "legal_status_breakdown": {"اصلية": 83, "معدلة": 0, "ملغاة": 0, "مضافة": 0},
