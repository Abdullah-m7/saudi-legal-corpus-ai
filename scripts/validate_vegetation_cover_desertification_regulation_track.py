#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the اللائحة التنفيذية لتنمية الغطاء النباتي ومكافحة التصحر track.
...
RECORDS = os.path.join(ROOT, "sources", "vegetation_cover_desertification_regulation", "verified",
                       "vegetation_cover_desertification_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "vegetation_cover_desertification_regulation", "verified",
                       "vegetation_cover_desertification_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "vegetation_cover_desertification_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"vegetation_cover_desertification_regulation_no_decision_number_in_source", "vegetation_cover_desertification_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "اللائحة التنفيذية لتنمية الغطاء النباتي ومكافحة التصحر":
    ...
    if e:
        print("FAIL: %d error(s) in Executive Regulation for the Development of Vegetation Cover and Combating Desertification track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Executive Regulation for the Development of Vegetation Cover and Combating Desertification")
