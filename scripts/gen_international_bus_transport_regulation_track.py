#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اللائحة المنظمة لنشاط النقل الدولي للركاب بالحافلات track.
...
OUT_VER = os.path.join(ROOT, "sources", "international_bus_transport_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "international_bus_transport_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "international_bus_transport_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "international_bus_transport_regulation_arabic_legal_llm",
                        "international_bus_transport_regulation_legal_llm_001_047.json")

LAW_ID = "sa-international-bus-transport-regulation"
LAW_AR = "اللائحة المنظمة لنشاط النقل الدولي للركاب بالحافلات"
...
def main():
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "international_bus_transport_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "INTERNATIONAL_BUS_TRANSPORT_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "international-bus-transport-regulation-llm-%03d" % idx,
            ...
            "article_path": "international_bus_transport_regulation/regulation/%s" % key,
    ...
    json.dump({
        "law_key": "international_bus_transport_regulation",
        "layer": "INTERNATIONAL_BUS_TRANSPORT_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "international-bus-transport-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (47 مادة، جميعها أصلية)",
        "title_en": "Regulation Governing International Passenger Transport by Bus — Arabic LLM-ready layer (47 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Regulation Governing International Passenger Transport by Bus records" % (len(ver), len(llm)))
