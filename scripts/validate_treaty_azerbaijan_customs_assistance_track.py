#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the اتفاقية بين حكومتي المملكة وأذربيجان حول التعاون والمساعدة المتبادلة في المسائل الجمركية track.
...
RECORDS = os.path.join(ROOT, "sources", "treaty_azerbaijan_customs_assistance", "verified",
                       "treaty_azerbaijan_customs_assistance_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "treaty_azerbaijan_customs_assistance", "verified",
                       "treaty_azerbaijan_customs_assistance_verified_summary.json")
LLM = os.path.join(ROOT, "data", "treaty_azerbaijan_customs_assistance_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"treaty_azerbaijan_customs_assistance_no_decision_number_in_source", "treaty_azerbaijan_customs_assistance_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "اتفاقية بين حكومتي المملكة وأذربيجان حول التعاون والمساعدة المتبادلة في المسائل الجمركية":
    ...
    if e:
        print("FAIL: %d error(s) in Saudi Arabia–Azerbaijan Agreement on Cooperation and Mutual Assistance in Customs Matters track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Saudi Arabia–Azerbaijan Agreement on Cooperation and Mutual Assistance in Customs Matters")
