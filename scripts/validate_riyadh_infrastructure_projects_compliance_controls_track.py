#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the ضوابط الرقابة والامتثال والتراخيص لأعمال مشاريع البنية التحتية بمنطقة الرياض track.
...
RECORDS = os.path.join(ROOT, "sources", "riyadh_infrastructure_projects_compliance_controls", "verified",
                       "riyadh_infrastructure_projects_compliance_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "riyadh_infrastructure_projects_compliance_controls", "verified",
                       "riyadh_infrastructure_projects_compliance_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "riyadh_infrastructure_projects_compliance_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"riyadh_infrastructure_projects_compliance_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "ضوابط الرقابة والامتثال والتراخيص لأعمال مشاريع البنية التحتية بمنطقة الرياض":
    ...
    if e:
        print("FAIL: %d error(s) in Oversight, Compliance and Licensing Controls for Infrastructure Project Works in the Riyadh Region track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Oversight, Compliance and Licensing Controls for Infrastructure Project Works in the Riyadh Region")
