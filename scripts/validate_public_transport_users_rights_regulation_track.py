#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the لائحة حقوق والتزامات مستخدمي وسائل النقل العام track.
...
RECORDS = os.path.join(ROOT, "sources", "public_transport_users_rights_regulation", "verified",
                       "public_transport_users_rights_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "public_transport_users_rights_regulation", "verified",
                       "public_transport_users_rights_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "public_transport_users_rights_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"public_transport_users_rights_regulation_no_decision_number_in_source", "public_transport_users_rights_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "لائحة حقوق والتزامات مستخدمي وسائل النقل العام":
    ...
    if e:
        print("FAIL: %d error(s) in Regulation on the Rights and Obligations of Public Transport Users track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Regulation on the Rights and Obligations of Public Transport Users")
