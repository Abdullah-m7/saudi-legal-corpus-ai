...
ARTICLES = [
    ...
    art(37, "management",
        "صلاحيات الإدارة",
        "管理权限",
        "يتولّى الإدارة الشركاء، ويجوز الاتفاق على تعيين مدير أو أكثر من الشركاء أو من غيرهم. وعلى "
        "الشريك ذي الصفة الاعتبارية أن يعيّن من يمثّله في إدارة الشركة. وإذا تعدّد المديرون دون تحديد "
        "اختصاص كلٍّ منهم ودون منع الانفراد، جاز لكلٍّ منهم الانفراد بأعمال الإدارة، ولباقي المديرين "
        "الاعتراض قبل أن يُبرم العمل ملزِماً في مواجهة الغير، وحينئذٍ تكون العبرة بأغلبية المديرين، فإن "
        "تساوت الآراء رُفع الأمر إلى الشركاء. ويمثّل المدير الشركة في حدود غرضها أمام المحاكم وهيئات "
        "التحكيم والغير، ما لم تُقيَّد صلاحياته صراحةً في عقد التأسيس. وتلتزم الشركة بكل عمل يجريه المدير "
        "باسمها وفي حدود غرضها، إلا إذا كان من تعامل معه سيّئ النية.",
        "第三十七条（管理权限）：公司由合伙人管理，亦可约定从合伙人或外部人员中任命一名或多名经理。"
        "法人合伙人应指定其在公司管理中的代表。若经理为多人且未划分各自权限、亦未禁止单独行事，则"
        "每名经理均可单独执行管理事务；其余经理有权在该行为对第三人生效之前提出异议，此时以经理的"
        "多数意见为准，意见相等时提交合伙人决定。经理在公司经营范围内代表公司面对法院、仲裁机构及"
        "第三人；除非设立协议明文限制其权限。公司在其经营范围内受经理以公司名义所作行为的约束，"
        "除非交易相对人为恶意。",
        "Article 37 — Management Powers",
        ["الإدارة", "المدير", "التمثيل", "المحاكم", "هيئات التحكيم", "سوء النية"],
        ["管理", "经理", "法人合伙人", "法院", "仲裁机构", "第三人", "恶意"],
        "Management by partners or appointed managers; a legal-person partner designates its "
        "representative; the manager represents the company before courts, arbitration bodies "
        "and third parties within its purpose unless the deed expressly restricts powers; the "
        "company is bound unless the counterparty acted in bad faith."),
    ...
    art(39, "management",
        ...
        "公司权利进行和解、出售或抵押公司不动产（属经营范围内的出售除外）、出售或抵押营业资产"
        "（商业店铺），以及代表公司借款。",
