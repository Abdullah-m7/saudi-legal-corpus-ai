#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the لائحة التراخيص - هيئة فنون العمارة والتصميم track.
...
RECORDS = os.path.join(ROOT, "sources", "architecture_design_authority_licensing_regulation", "verified",
                       "architecture_design_authority_licensing_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "architecture_design_authority_licensing_regulation", "verified",
                       "architecture_design_authority_licensing_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "architecture_design_authority_licensing_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"architecture_design_authority_licensing_regulation_no_decision_number_in_source", "architecture_design_authority_licensing_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "لائحة التراخيص - هيئة فنون العمارة والتصميم":
    ...
    if e:
        print("FAIL: %d error(s) in Licensing Regulation — Architecture and Design Authority track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Licensing Regulation — Architecture and Design Authority")
