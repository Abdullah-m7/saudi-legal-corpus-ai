...
RECORDS = os.path.join(ROOT, "sources", "marina_design_operation_controls", "verified",
                       "marina_design_operation_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "marina_design_operation_controls", "verified",
                       "marina_design_operation_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "marina_design_operation_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"marina_design_operation_controls_no_decision_number_in_source", "marina_design_operation_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if e:
        print("FAIL: %d error(s) in Controls and Procedures for the Design and Operation of Tourist Marinas track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls and Procedures for the Design and Operation of Tourist Marinas")
