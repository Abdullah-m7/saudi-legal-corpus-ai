...
# -*- coding: utf-8 -*-
"""
English Legal LLM-ready layer — Book 1 (General Provisions, Articles 1-34).

Backfills the English Legal LLM layer for Book 1 — one `article_reference` record per
article, Articles 1-34. This complements the existing repo book4 English Legal LLM
...
record's `english_reference_text` in `data/english_reference/book1_en_reference.json`,
...
Reads : data/english_reference/book1_en_reference.json
Writes: data/english_legal_llm/book1_en_legal_llm.json
"""
...
BOOK = 1
ARTICLE_RANGE = list(range(1, 35))   # 1-34
SRC_REL = "data/english_reference/book1_en_reference.json"
OUT_REL = "data/english_legal_llm/book1_en_legal_llm.json"
...
def main():
    ...
    payload = {
        ...
        "scope": "book1_general_provisions",
        "book": BOOK,
        "section_key": "general_provisions",
        "section_title_en": "General Provisions",
        "article_range": "1-34",
