...
RECORDS = os.path.join(ROOT, "sources", "valuation_profession_conduct_rules", "verified",
                       "valuation_profession_conduct_rules_verified_records.jsonl")
...
def main():
    ...
    if e:
        print("FAIL: %d error(s) in Code of Conduct and Ethics of the Valuation Profession track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
