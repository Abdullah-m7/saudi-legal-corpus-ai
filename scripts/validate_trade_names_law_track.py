#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the Trade Names Law track (23 records).

Trust gate (BOE-archive provenance): the numbered sequence is a complete 1..23
...
RECORDS = os.path.join(ROOT, "sources", "trade_names", "law", "verified",
                       "trade_names_law_verified_records.jsonl")
LLM = os.path.join(ROOT, "data", "trade_names_arabic_legal_llm",
                   "trade_names_law_legal_llm_001_023.json")
STATUS = "BOE_OFFICIAL_PORTAL_ARCHIVE_CROSS_SNAPSHOT_VERIFIED"
N = 23
KEY_RE = r"trade_names_art_(\d{3})"
LAW_NAME = "Trade Names Law"
