#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the نظام حقوق المؤلف track.
...
server-rendered HTML page (uqn.gov.sa/details?p=4000299),
...
STRUCTURE: 61 numbered articles, no appendix records. All اصلية.
...
SRC = os.path.join(ROOT, "sources", "copyright_law_2026", "official_source",
                   "copyright_law_2026_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "copyright_law_2026", "verified")
RECORDS = os.path.join(OUT_VER, "copyright_law_2026_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "copyright_law_2026_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "copyright_law_2026_arabic_legal_llm",
                        "copyright_law_2026_legal_llm_001_061.json")

LAW_ID = "sa-copyright-law-2026"
LAW_AR = "نظام حقوق المؤلف"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"copyright_law_2026_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=4000299), published 25/8/1447H (2026-02-13). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "copyright_law_2026",
            "law_component": "law",
            "language": "ar",
            "record_layer": "COPYRIGHT_LAW_2026_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "copyright-law-2026-llm-%03d" % idx,
            ...
            "article_path": "copyright_law_2026/law/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Copyright Law -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 25/8/1447H / 2026-02-13)"),
                "source_authority_ar": ("نظام حقوق المؤلف — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "copyright_law_2026",
        "layer": "COPYRIGHT_LAW_2026_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "copyright-law-2026-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "law",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (61 مادة، جميعها أصلية)",
        "title_en": "Copyright Law — Arabic LLM-ready layer (61 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
