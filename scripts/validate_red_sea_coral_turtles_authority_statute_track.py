#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the تنظيم المؤسسة العامة للمحافظة على الشعب المرجانية والسلاحف في البحر الأحمر track.
...
RECORDS = os.path.join(ROOT, "sources", "red_sea_coral_turtles_authority_statute", "verified",
                       "red_sea_coral_turtles_authority_statute_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "red_sea_coral_turtles_authority_statute", "verified",
                       "red_sea_coral_turtles_authority_statute_verified_summary.json")
LLM = os.path.join(ROOT, "data", "red_sea_coral_turtles_authority_statute_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"red_sea_coral_turtles_authority_statute_no_decision_number_in_source", "red_sea_coral_turtles_authority_statute_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "تنظيم المؤسسة العامة للمحافظة على الشعب المرجانية والسلاحف في البحر الأحمر":
    ...
    if e:
        print("FAIL: %d error(s) in Statute of the General Authority for the Conservation of Coral Reefs and Turtles in the Red Sea track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Statute of the General Authority for the Conservation of Coral Reefs and Turtles in the Red Sea")
