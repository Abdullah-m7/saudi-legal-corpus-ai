#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اللائحة التنفيذية لقانون (نظام) المبيدات في دول مجلس التعاون لدول الخليج العربية بالمملكة track.
...
server-rendered HTML page (uqn.gov.sa/details?p=24884),
...
STRUCTURE: 51 numbered articles, no appendix records. All اصلية.
...
SRC = os.path.join(ROOT, "sources", "gcc_pesticides_regulation", "official_source",
                   "gcc_pesticides_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "gcc_pesticides_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "gcc_pesticides_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "gcc_pesticides_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "gcc_pesticides_regulation_arabic_legal_llm",
                        "gcc_pesticides_regulation_legal_llm_001_051.json")

LAW_ID = "sa-gcc-pesticides-regulation"
LAW_AR = "اللائحة التنفيذية لقانون (نظام) المبيدات في دول مجلس التعاون لدول الخليج العربية بالمملكة"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"gcc_pesticides_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=24884), published 17/10/1445H (2024-04-26). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "gcc_pesticides_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "GCC_PESTICIDES_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "gcc-pesticides-regulation-llm-%03d" % idx,
            ...
            "article_path": "gcc_pesticides_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Executive Regulation of the GCC Pesticides Law in the Kingdom -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 17/10/1445H / 2024-04-26)"),
                "source_authority_ar": ("اللائحة التنفيذية لقانون (نظام) المبيدات في دول مجلس التعاون لدول الخليج العربية بالمملكة — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "gcc_pesticides_regulation",
        "layer": "GCC_PESTICIDES_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "gcc-pesticides-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (51 مادة، جميعها أصلية)",
        "title_en": "Executive Regulation of the GCC Pesticides Law in the Kingdom — Arabic LLM-ready layer (51 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Executive Regulation of the GCC Pesticides Law in the Kingdom records" % (len(ver), len(llm)))
