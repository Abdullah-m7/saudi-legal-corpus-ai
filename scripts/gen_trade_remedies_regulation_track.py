#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اللائحة التنفيذية لنظام المعالجات التجارية في التجارة الدولية track.
...
server-rendered HTML page (uqn.gov.sa/details?p=21573),
published 21/8/1444H (2023-03-13). The Gazette IS the official publication of record
...
STRUCTURE: 64 numbered articles, no appendix records. All اصلية.
...
SRC = os.path.join(ROOT, "sources", "trade_remedies_regulation", "official_source",
                   "trade_remedies_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "trade_remedies_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "trade_remedies_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "trade_remedies_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "trade_remedies_regulation_arabic_legal_llm",
                        "trade_remedies_regulation_legal_llm_001_064.json")

LAW_ID = "sa-trade-remedies-regulation"
LAW_AR = "اللائحة التنفيذية لنظام المعالجات التجارية في التجارة الدولية"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"trade_remedies_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=21573), published 21/8/1444H (2023-03-13). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "trade_remedies_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "TRADE_REMEDIES_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "trade-remedies-regulation-llm-%03d" % idx,
            ...
            "article_path": "trade_remedies_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Executive Regulation of the Law of Trade Remedies in International Trade -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 21/8/1444H / 2023-03-13)"),
                "source_authority_ar": ("اللائحة التنفيذية لنظام المعالجات التجارية في التجارة الدولية — النص الكامل جُلب مباشرة من صفحة جريدة أم "
                                        "القرى الرسمية (تاريخ النشر 21/8/1444هـ الموافق 2023-03-13م)"),
    ...
    json.dump({
        "law_key": "trade_remedies_regulation",
        "layer": "TRADE_REMEDIES_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "trade-remedies-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (64 مادة، جميعها أصلية)",
        "title_en": "Executive Regulation of the Law of Trade Remedies in International Trade — Arabic LLM-ready layer (64 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Executive Regulation of the Law of Trade Remedies in International Trade records" % (len(ver), len(llm)))
