#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the الضوابط المنظمة للرسوم الدراسية في المدارس الأهلية 1444ه - 2023م track.
...
server-rendered HTML page (uqn.gov.sa/details?p=21413),
...
SRC = os.path.join(ROOT, "sources", "private_schools_tuition_controls", "official_source",
                   "private_schools_tuition_controls_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "private_schools_tuition_controls", "verified")
RECORDS = os.path.join(OUT_VER, "private_schools_tuition_controls_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "private_schools_tuition_controls_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "private_schools_tuition_controls_arabic_legal_llm",
                        "private_schools_tuition_controls_legal_llm_001_009.json")

LAW_ID = "sa-private-schools-tuition-controls"
LAW_AR = "الضوابط المنظمة للرسوم الدراسية في المدارس الأهلية 1444ه - 2023م"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"private_schools_tuition_controls_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=21413), published 19/7/1444H (2023-02-10). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "private_schools_tuition_controls",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "PRIVATE_SCHOOLS_TUITION_CONTROLS_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "private-schools-tuition-controls-llm-%03d" % idx,
            ...
            "article_path": "private_schools_tuition_controls/rules/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Controls Governing Tuition Fees in Private Schools 1444H - 2023 -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 19/7/1444H / 2023-02-10)"),
                "source_authority_ar": ("الضوابط المنظمة للرسوم الدراسية في المدارس الأهلية 1444ه - 2023م — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "private_schools_tuition_controls",
        "layer": "PRIVATE_SCHOOLS_TUITION_CONTROLS_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "private-schools-tuition-controls-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (9 مادة، جميعها أصلية)",
        "title_en": "Controls Governing Tuition Fees in Private Schools 1444H - 2023 — Arabic LLM-ready layer (9 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Controls Governing Tuition Fees in Private Schools 1444H - 2023 records" % (len(ver), len(llm)))
