...
and each of the 159 tracks' own `official_source.json`-equivalent file, and produces a single
...
scripts/gen_corpus_verification_tiers.py:
  - It does NOT modify the registry, the verification-tiers file, or any of the 159 tracks'
...
def main() -> int:
    ...
    out = {
        ...
        "notes": (
            "Purely additive, read-only survey layer over this corpus's 159 tracks, built "
            ...
            "tiers file, or any of the 159 tracks' own files. For a LIVE (network-dependent, "
