...
and each of the 135 tracks' own `official_source.json`-equivalent file, and produces a single
...
scripts/gen_corpus_verification_tiers.py:
  - It does NOT modify the registry, the verification-tiers file, or any of the 135 tracks'
...
def resolve_official_source_path(track_id: str, data_paths: list[str]) -> str | None:
    ...
    special = {
        "companies_law": "data/legal_corpus_factory/law_profiles/sa_companies_law_m135_1443.profile.json",
...
def main() -> int:
    ...
    out = {
        ...
        "notes": (
            "Purely additive, read-only survey layer over this corpus's 135 tracks, built "
            ...
            "tiers file, or any of the 135 tracks' own files. For a LIVE (network-dependent, "
