...
and each of the 132 tracks' own `official_source.json`-equivalent file, and produces a single
...
scripts/gen_corpus_verification_tiers.py:
  - It does NOT modify the registry, the verification-tiers file, or any of the 132 tracks'
...
def main() -> int:
    ...
    out = {
        ...
        "notes": (
            "Purely additive, read-only survey layer over this corpus's 132 tracks, built "
            ...
            "tiers file, or any of the 132 tracks' own files. For a LIVE (network-dependent, "
