#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the لائحة مرافق الإيواء السياحي track.
...
RECORDS = os.path.join(ROOT, "sources", "tourist_accommodation_facilities_regulation", "verified",
                       "tourist_accommodation_facilities_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "tourist_accommodation_facilities_regulation", "verified",
                       "tourist_accommodation_facilities_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "tourist_accommodation_facilities_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"tourist_accommodation_facilities_regulation_no_decision_number_in_source", "tourist_accommodation_facilities_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "لائحة مرافق الإيواء السياحي":
    ...
    if e:
        print("FAIL: %d error(s) in Regulation on Tourist Accommodation Facilities track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Regulation on Tourist Accommodation Facilities")
