#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the قواعد عمل اللجان الزكوية والضريبية والجمركية track.
...
server-rendered HTML page (uqn.gov.sa/details?p=23956),
...
SRC = os.path.join(ROOT, "sources", "zakat_tax_customs_committees_rules", "official_source",
                   "zakat_tax_customs_committees_rules_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "zakat_tax_customs_committees_rules", "verified")
RECORDS = os.path.join(OUT_VER, "zakat_tax_customs_committees_rules_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "zakat_tax_customs_committees_rules_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "zakat_tax_customs_committees_rules_arabic_legal_llm",
                        "zakat_tax_customs_committees_rules_legal_llm_001_051.json")

LAW_ID = "sa-zakat-tax-customs-committees-rules"
LAW_AR = "قواعد عمل اللجان الزكوية والضريبية والجمركية"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"zakat_tax_customs_committees_rules_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=23956), published 12/4/1445H (2023-10-27). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "zakat_tax_customs_committees_rules",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "ZAKAT_TAX_CUSTOMS_COMMITTEES_RULES_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "zakat-tax-customs-committees-rules-llm-%03d" % idx,
            ...
            "article_path": "zakat_tax_customs_committees_rules/rules/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Rules of Procedure of the Zakat, Tax and Customs Committees -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 12/4/1445H / 2023-10-27)"),
                "source_authority_ar": ("قواعد عمل اللجان الزكوية والضريبية والجمركية — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "zakat_tax_customs_committees_rules",
        "layer": "ZAKAT_TAX_CUSTOMS_COMMITTEES_RULES_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "zakat-tax-customs-committees-rules-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (51 مادة، جميعها أصلية)",
        "title_en": "Rules of Procedure of the Zakat, Tax and Customs Committees — Arabic LLM-ready layer (51 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Rules of Procedure of the Zakat, Tax and Customs Committees records" % (len(ver), len(llm)))
