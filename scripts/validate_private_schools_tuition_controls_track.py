#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the الضوابط المنظمة للرسوم الدراسية في المدارس الأهلية 1444ه - 2023م track.
...
RECORDS = os.path.join(ROOT, "sources", "private_schools_tuition_controls", "verified",
                       "private_schools_tuition_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "private_schools_tuition_controls", "verified",
                       "private_schools_tuition_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "private_schools_tuition_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"private_schools_tuition_controls_no_decision_number_in_source", "private_schools_tuition_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "الضوابط المنظمة للرسوم الدراسية في المدارس الأهلية 1444ه - 2023م":
    ...
    if e:
        print("FAIL: %d error(s) in Controls Governing Tuition Fees in Private Schools 1444H - 2023 track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls Governing Tuition Fees in Private Schools 1444H - 2023")
