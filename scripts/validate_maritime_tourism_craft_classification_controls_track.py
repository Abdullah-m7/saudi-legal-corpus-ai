#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the الضوابط والاجراءات لتصنيف الوسايط البحرية السياحية track.
...
RECORDS = os.path.join(ROOT, "sources", "maritime_tourism_craft_classification_controls", "verified",
                       "maritime_tourism_craft_classification_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "maritime_tourism_craft_classification_controls", "verified",
                       "maritime_tourism_craft_classification_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "maritime_tourism_craft_classification_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"maritime_tourism_craft_classification_controls_no_decision_number_in_source", "maritime_tourism_craft_classification_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "الضوابط والاجراءات لتصنيف الوسايط البحرية السياحية":
    ...
    if e:
        print("FAIL: %d error(s) in Controls and Procedures for Classifying Maritime Tourism Craft track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls and Procedures for Classifying Maritime Tourism Craft")
