#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the تنظيم مركز الملك عبدالله بن عبدالعزيز للتخطيط والسياسات اللغوية track.
...
RECORDS = os.path.join(ROOT, "sources", "king_abdullah_language_planning_center_statute", "verified",
                       "king_abdullah_language_planning_center_statute_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "king_abdullah_language_planning_center_statute", "verified",
                       "king_abdullah_language_planning_center_statute_verified_summary.json")
LLM = os.path.join(ROOT, "data", "king_abdullah_language_planning_center_statute_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"king_abdullah_language_planning_center_statute_no_decision_number_in_source", "king_abdullah_language_planning_center_statute_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "تنظيم مركز الملك عبدالله بن عبدالعزيز للتخطيط والسياسات اللغوية":
    ...
    if e:
        print("FAIL: %d error(s) in Statute of the King Abdullah bin Abdulaziz Center for Language Planning and Policy track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Statute of the King Abdullah bin Abdulaziz Center for Language Planning and Policy")
