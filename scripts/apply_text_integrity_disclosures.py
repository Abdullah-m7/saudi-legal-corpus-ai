...
DAMAGE_TEXT = (
    ...
    "النص العربي من ملف PDF: انقلاب رابطة لام-ألف — «االطلاع» موضع «الاطلاع»، و«اإلدارية» "
    "موضع «الإدارية»، و«إعالن» موضع «إعلان»، و«الالزمة» موضع «اللازمة»، و«الالئحة» موضع "
    "«اللائحة». وهو خلل في **النقل** لا في المصدر: الجهة نشرت النص سليماً.\n\n"
    "**ولم يُصحَّح حرف واحد، والسبب أقوى من مجرد الاحتياط**: هذا الانقلاب **يُحوِّل كلمات "
    "عربية صحيحة إلى كلمات عربية صحيحة أخرى**. فـ«العالقة» (المُعلَّقة) هي قلبُ «العلاقة»، "
    "و«عالمة» (التي تعلم) قلبُ «علامة»، و«صالحية» قلبُ «صلاحية» — و«الشوائب **العالقة** ببدن "
    "السفينة» و«القضايا **العالقة** لدى المحامين» صوابٌ يقول ما يعنيه بالضبط. فلا قاعدةَ "
    "آليةٌ تفصل العطب عن الصواب هنا؛ الفصل يحتاج الجملة لا الرسم. وقد جُرِّب إصلاحٌ آليٌّ "
    "مشروطٌ بأن يكون الشكل المُصحَّح مشهوداً في نصوص المستودع السليمة، **فأخفق**: منه ما ينتج "
    "عنه نصٌّ لا يزال خاطئاً لأن الاستخراج شطر الكلمة أيضاً («خ اال المدة» وأصلها «خلال "
    "المدة»)، ومنه ما «يشهد له» عطبٌ مماثل تسرَّب إلى مسارٍ آخر.\n\n"
    "المُفصَح عنه أن **رسم بعض الكلمات في هذه السجلات لا يطابق ما نشرته الجهة**، وإن بقي "
    "المعنى مقروءاً؛ فلا يصح النسخ الحرفي منها قبل المقابلة بالمصدر الرسمي. ويُرفع هذا "
    "التحفُّظ بإعادة قراءة النص من مصدره واستبداله حرفياً، لا بقاعدة. "
