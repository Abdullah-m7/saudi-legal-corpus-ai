#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the ضوابط التسميات التسويقية للمدن الاقتصادية والمناطق الاقتصادية الخاصة track.
...
RECORDS = os.path.join(ROOT, "sources", "economic_cities_marketing_names_controls", "verified",
                       "economic_cities_marketing_names_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "economic_cities_marketing_names_controls", "verified",
                       "economic_cities_marketing_names_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "economic_cities_marketing_names_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"economic_cities_marketing_names_controls_no_decision_number_in_source", "economic_cities_marketing_names_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "ضوابط التسميات التسويقية للمدن الاقتصادية والمناطق الاقتصادية الخاصة":
    ...
    if e:
        print("FAIL: %d error(s) in Controls on the Marketing Designations of Economic Cities and Special Economic Zones track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls on the Marketing Designations of Economic Cities and Special Economic Zones")
