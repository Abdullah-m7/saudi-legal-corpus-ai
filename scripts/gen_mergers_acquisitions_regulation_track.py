#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the لائحة الاندماج والاستحواذ track.
...
server-rendered HTML page (uqn.gov.sa/details?p=21696),
...
SRC = os.path.join(ROOT, "sources", "mergers_acquisitions_regulation", "official_source",
                   "mergers_acquisitions_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "mergers_acquisitions_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "mergers_acquisitions_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "mergers_acquisitions_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "mergers_acquisitions_regulation_arabic_legal_llm",
                        "mergers_acquisitions_regulation_legal_llm_001_053.json")

LAW_ID = "sa-mergers-acquisitions-regulation"
LAW_AR = "لائحة الاندماج والاستحواذ"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"mergers_acquisitions_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=21696), published 23/9/1444H (2023-04-14). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "mergers_acquisitions_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "MERGERS_ACQUISITIONS_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "mergers-acquisitions-regulation-llm-%03d" % idx,
            ...
            "article_path": "mergers_acquisitions_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Merger and Acquisition Regulations -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 23/9/1444H / 2023-04-14)"),
                "source_authority_ar": ("لائحة الاندماج والاستحواذ — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "mergers_acquisitions_regulation",
        "layer": "MERGERS_ACQUISITIONS_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "mergers-acquisitions-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (53 مادة، جميعها أصلية)",
        "title_en": "Merger and Acquisition Regulations — Arabic LLM-ready layer (53 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Merger and Acquisition Regulations records" % (len(ver), len(llm)))
