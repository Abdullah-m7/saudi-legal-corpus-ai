#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the اللائحة الفنية للتوافق الكهرومغناطيسي track.
...
RECORDS = os.path.join(ROOT, "sources", "electromagnetic_compatibility_technical_regulation", "verified",
                       "electromagnetic_compatibility_technical_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "electromagnetic_compatibility_technical_regulation", "verified",
                       "electromagnetic_compatibility_technical_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "electromagnetic_compatibility_technical_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"electromagnetic_compatibility_technical_regulation_no_decision_number_in_source", "electromagnetic_compatibility_technical_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "اللائحة الفنية للتوافق الكهرومغناطيسي":
    ...
    if e:
        print("FAIL: %d error(s) in Technical Regulation for Electromagnetic Compatibility track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Technical Regulation for Electromagnetic Compatibility")
