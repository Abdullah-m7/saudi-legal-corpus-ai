...
server-rendered HTML page (uqn.gov.sa/details?p=17783),
...
SRC = os.path.join(ROOT, "sources", "free_zone_employees_treatment_rules", "official_source",
                   "free_zone_employees_treatment_rules_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "free_zone_employees_treatment_rules", "verified")
RECORDS = os.path.join(OUT_VER, "free_zone_employees_treatment_rules_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "free_zone_employees_treatment_rules_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "free_zone_employees_treatment_rules_arabic_legal_llm",
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=17783), published 1/11/1442H (2021-06-11). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "free_zone_employees_treatment_rules",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "FREE_ZONE_EMPLOYEES_TREATMENT_RULES_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "free-zone-employees-treatment-rules-llm-%03d" % idx,
            ...
            "article_path": "free_zone_employees_treatment_rules/rules/%s" % key,
    ...
    json.dump({
        "law_key": "free_zone_employees_treatment_rules",
        "layer": "FREE_ZONE_EMPLOYEES_TREATMENT_RULES_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "free-zone-employees-treatment-rules-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
