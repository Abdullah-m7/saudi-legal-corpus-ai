#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اتفاقية بين حكومة المملكة وحكومة جمهورية البرازيل بشأن تنظيم إجراءات منح مواطني البلدين تأشيرة زيارة track.
...
server-rendered HTML page (uqn.gov.sa/details?p=17391),
...
SRC = os.path.join(ROOT, "sources", "treaty_brazil_visit_visas", "official_source",
                   "treaty_brazil_visit_visas_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "treaty_brazil_visit_visas", "verified")
RECORDS = os.path.join(OUT_VER, "treaty_brazil_visit_visas_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "treaty_brazil_visit_visas_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "treaty_brazil_visit_visas_arabic_legal_llm",
                        "treaty_brazil_visit_visas_legal_llm_001_013.json")

LAW_ID = "sa-treaty-brazil-visit-visas"
LAW_AR = "اتفاقية بين حكومة المملكة وحكومة جمهورية البرازيل بشأن تنظيم إجراءات منح مواطني البلدين تأشيرة زيارة"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"treaty_brazil_visit_visas_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=17391), published 24/5/1442H (2021-01-08). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "treaty_brazil_visit_visas",
            "law_component": "treaty",
            "language": "ar",
            "record_layer": "TREATY_BRAZIL_VISIT_VISAS_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "treaty-brazil-visit-visas-llm-%03d" % idx,
            ...
            "article_path": "treaty_brazil_visit_visas/treaty/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Saudi Arabia–Brazil Agreement on Visit Visa Procedures -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 24/5/1442H / 2021-01-08)"),
                "source_authority_ar": ("اتفاقية بين حكومة المملكة وحكومة جمهورية البرازيل بشأن تنظيم إجراءات منح مواطني البلدين تأشيرة زيارة — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "treaty_brazil_visit_visas",
        "layer": "TREATY_BRAZIL_VISIT_VISAS_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "treaty-brazil-visit-visas-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "treaty",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (13 مادة، جميعها أصلية)",
        "title_en": "Saudi Arabia–Brazil Agreement on Visit Visa Procedures — Arabic LLM-ready layer (13 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Saudi Arabia–Brazil Agreement on Visit Visa Procedures records" % (len(ver), len(llm)))
