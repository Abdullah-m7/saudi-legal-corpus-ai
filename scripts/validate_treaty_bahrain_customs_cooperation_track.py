#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the اتفاقية التعاون الجمركي المشترك بين هيئة الزكاة والضريبة والجمارك في المملكة وشؤون الجمارك بمملكة البحرين track.
...
RECORDS = os.path.join(ROOT, "sources", "treaty_bahrain_customs_cooperation", "verified",
                       "treaty_bahrain_customs_cooperation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "treaty_bahrain_customs_cooperation", "verified",
                       "treaty_bahrain_customs_cooperation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "treaty_bahrain_customs_cooperation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"treaty_bahrain_customs_cooperation_no_decision_number_in_source", "treaty_bahrain_customs_cooperation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "اتفاقية التعاون الجمركي المشترك بين هيئة الزكاة والضريبة والجمارك في المملكة وشؤون الجمارك بمملكة البحرين":
    ...
    if e:
        print("FAIL: %d error(s) in Saudi–Bahraini Joint Customs Cooperation Agreement track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Saudi–Bahraini Joint Customs Cooperation Agreement")
