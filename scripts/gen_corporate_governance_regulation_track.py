#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the لائحة حوكمة الشركات track.
...
server-rendered HTML page (uqn.gov.sa/details?p=21707),
...
SRC = os.path.join(ROOT, "sources", "corporate_governance_regulation", "official_source",
                   "corporate_governance_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "corporate_governance_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "corporate_governance_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "corporate_governance_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "corporate_governance_regulation_arabic_legal_llm",
                        "corporate_governance_regulation_legal_llm_001_095.json")

LAW_ID = "sa-corporate-governance-regulation"
LAW_AR = "لائحة حوكمة الشركات"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"corporate_governance_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=21707), published 23/9/1444H (2023-04-14). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "corporate_governance_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "CORPORATE_GOVERNANCE_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "corporate-governance-regulation-llm-%03d" % idx,
            ...
            "article_path": "corporate_governance_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Corporate Governance Regulations -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 23/9/1444H / 2023-04-14)"),
                "source_authority_ar": ("لائحة حوكمة الشركات — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "corporate_governance_regulation",
        "layer": "CORPORATE_GOVERNANCE_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "corporate-governance-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (95 مادة، جميعها أصلية)",
        "title_en": "Corporate Governance Regulations — Arabic LLM-ready layer (95 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Corporate Governance Regulations records" % (len(ver), len(llm)))
