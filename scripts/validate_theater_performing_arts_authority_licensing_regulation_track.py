#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the لائحة التراخيص - هيئة المسرح والفنون الأدائية track.
...
RECORDS = os.path.join(ROOT, "sources", "theater_performing_arts_authority_licensing_regulation", "verified",
                       "theater_performing_arts_authority_licensing_regulation_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "theater_performing_arts_authority_licensing_regulation", "verified",
                       "theater_performing_arts_authority_licensing_regulation_verified_summary.json")
LLM = os.path.join(ROOT, "data", "theater_performing_arts_authority_licensing_regulation_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"theater_performing_arts_authority_licensing_regulation_no_decision_number_in_source", "theater_performing_arts_authority_licensing_regulation_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "لائحة التراخيص - هيئة المسرح والفنون الأدائية":
    ...
    if e:
        print("FAIL: %d error(s) in Licensing Regulation — Theater and Performing Arts Authority track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Licensing Regulation — Theater and Performing Arts Authority")
