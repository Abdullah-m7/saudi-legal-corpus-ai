#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the القواعد العامة المنظمة لعمل أسواق النفع العام وضوابط أعمال مقدمي الخدمة track.
...
RECORDS = os.path.join(ROOT, "sources", "public_utility_markets_general_rules", "verified",
                       "public_utility_markets_general_rules_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "public_utility_markets_general_rules", "verified",
                       "public_utility_markets_general_rules_verified_summary.json")
LLM = os.path.join(ROOT, "data", "public_utility_markets_general_rules_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"public_utility_markets_general_rules_no_decision_number_in_source", "public_utility_markets_general_rules_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "القواعد العامة المنظمة لعمل أسواق النفع العام وضوابط أعمال مقدمي الخدمة":
    ...
    if e:
        print("FAIL: %d error(s) in General Rules Governing Public Utility Markets and Service Provider Controls track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: General Rules Governing Public Utility Markets and Service Provider Controls")
