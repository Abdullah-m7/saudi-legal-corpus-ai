...
def main() -> int:
    ...
    # [3] Exactly 198 tracks, matching REQUIRED_TRACK_IDS exactly (no missing, no extras)
    ...
    # [7] summary_by_tier matches a fresh recount; counts sum to total_tracks == 198
    ...
    check("[7b] total_tracks == 198...", out.get("total_tracks") == 198,
