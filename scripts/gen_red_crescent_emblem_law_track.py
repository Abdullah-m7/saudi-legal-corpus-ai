#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the نظام استخدام وحماية شارة واسم الهلال الأحمر وما في حكمهما track.
...
server-rendered HTML page (uqn.gov.sa/details?p=23412),
...
SRC = os.path.join(ROOT, "sources", "red_crescent_emblem_law", "official_source",
                   "red_crescent_emblem_law_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "red_crescent_emblem_law", "verified")
RECORDS = os.path.join(OUT_VER, "red_crescent_emblem_law_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "red_crescent_emblem_law_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "red_crescent_emblem_law_arabic_legal_llm",
                        "red_crescent_emblem_law_legal_llm_001_015.json")

LAW_ID = "sa-red-crescent-emblem-law"
LAW_AR = "نظام استخدام وحماية شارة واسم الهلال الأحمر وما في حكمهما"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"red_crescent_emblem_law_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=23412), published 17/1/1445H (2023-08-04). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "red_crescent_emblem_law",
            "law_component": "law",
            "language": "ar",
            "record_layer": "RED_CRESCENT_EMBLEM_LAW_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "red-crescent-emblem-law-llm-%03d" % idx,
            ...
            "article_path": "red_crescent_emblem_law/law/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Law on the Use and Protection of the Red Crescent Emblem and Name and their Equivalents -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 17/1/1445H / 2023-08-04)"),
                "source_authority_ar": ("نظام استخدام وحماية شارة واسم الهلال الأحمر وما في حكمهما — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "red_crescent_emblem_law",
        "layer": "RED_CRESCENT_EMBLEM_LAW_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "red-crescent-emblem-law-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "law",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (15 مادة، جميعها أصلية)",
        "title_en": "Law on the Use and Protection of the Red Crescent Emblem and Name and their Equivalents — Arabic LLM-ready layer (15 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Law on the Use and Protection of the Red Crescent Emblem and Name and their Equivalents records" % (len(ver), len(llm)))
