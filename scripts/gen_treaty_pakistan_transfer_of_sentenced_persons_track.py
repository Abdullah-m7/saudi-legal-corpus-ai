#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اتفاقية بين حكومتي المملكة وجمهورية باكستان الإسلامية لنقل المحكوم عليهم بعقوبات سالبة للحرية track.
...
server-rendered HTML page (uqn.gov.sa/details?p=19080),
published 8/8/1443H (2022-03-11). The Gazette IS the official publication of record
...
SRC = os.path.join(ROOT, "sources", "treaty_pakistan_transfer_of_sentenced_persons", "official_source",
                   "treaty_pakistan_transfer_of_sentenced_persons_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "treaty_pakistan_transfer_of_sentenced_persons", "verified")
RECORDS = os.path.join(OUT_VER, "treaty_pakistan_transfer_of_sentenced_persons_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "treaty_pakistan_transfer_of_sentenced_persons_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "treaty_pakistan_transfer_of_sentenced_persons_arabic_legal_llm",
                        "treaty_pakistan_transfer_of_sentenced_persons_legal_llm_001_017.json")

LAW_ID = "sa-treaty-pakistan-transfer-of-sentenced-persons"
LAW_AR = "اتفاقية بين حكومتي المملكة وجمهورية باكستان الإسلامية لنقل المحكوم عليهم بعقوبات سالبة للحرية"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"treaty_pakistan_transfer_of_sentenced_persons_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=19080), published 8/8/1443H (2022-03-11). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "treaty_pakistan_transfer_of_sentenced_persons",
            "law_component": "treaty",
            "language": "ar",
            "record_layer": "TREATY_PAKISTAN_TRANSFER_OF_SENTENCED_PERSONS_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "treaty-pakistan-transfer-of-sentenced-persons-llm-%03d" % idx,
            ...
            "article_path": "treaty_pakistan_transfer_of_sentenced_persons/treaty/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Saudi Arabia–Pakistan Agreement on the Transfer of Sentenced Persons -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 8/8/1443H / 2022-03-11)"),
                "source_authority_ar": ("اتفاقية بين حكومتي المملكة وجمهورية باكستان الإسلامية لنقل المحكوم عليهم بعقوبات سالبة للحرية — النص الكامل جُلب مباشرة من صفحة جريدة أم "
                                        "القرى الرسمية (تاريخ النشر 8/8/1443هـ الموافق 2022-03-11م)"),
    ...
    json.dump({
        "law_key": "treaty_pakistan_transfer_of_sentenced_persons",
        "layer": "TREATY_PAKISTAN_TRANSFER_OF_SENTENCED_PERSONS_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "treaty-pakistan-transfer-of-sentenced-persons-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "treaty",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (17 مادة، جميعها أصلية)",
        "title_en": "Saudi Arabia–Pakistan Agreement on the Transfer of Sentenced Persons — Arabic LLM-ready layer (17 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Saudi Arabia–Pakistan Agreement on the Transfer of Sentenced Persons records" % (len(ver), len(llm)))
