#!/usr/bin/env python3
"""Build data/articles/book4_provisions_084_102.jsonl (one line per provision)."""
...
OUT = os.path.join(ROOT, "data", "articles", "book4_provisions_084_102.jsonl")
        ...
        for p in provisions:
            chunk = {
                ...
                "source": {"input_pdf": p["source"]["input_pdf"], "book": 4,
                           "note": "Book Four model 1b — thematic provision (Section 3)"},
