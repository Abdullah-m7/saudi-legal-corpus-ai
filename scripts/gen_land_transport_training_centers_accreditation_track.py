#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the شروط وإجراءات تأهيل واعتماد مراكز التدريب ومراكز الاختبار لسائقي ومديري التشغيل في أنشطة النقل البري track.
...
server-rendered HTML page (uqn.gov.sa/details?p=26571),
...
SRC = os.path.join(ROOT, "sources", "land_transport_training_centers_accreditation", "official_source",
                   "land_transport_training_centers_accreditation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "land_transport_training_centers_accreditation", "verified")
RECORDS = os.path.join(OUT_VER, "land_transport_training_centers_accreditation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "land_transport_training_centers_accreditation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "land_transport_training_centers_accreditation_arabic_legal_llm",
                        "land_transport_training_centers_accreditation_legal_llm_001_014.json")

LAW_ID = "sa-land-transport-training-centers-accreditation"
LAW_AR = "شروط وإجراءات تأهيل واعتماد مراكز التدريب ومراكز الاختبار لسائقي ومديري التشغيل في أنشطة النقل البري"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"land_transport_training_centers_accreditation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=26571), published 1/4/1446H (2024-10-04). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "land_transport_training_centers_accreditation",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "LAND_TRANSPORT_TRAINING_CENTERS_ACCREDITATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "land-transport-training-centers-accreditation-llm-%03d" % idx,
            ...
            "article_path": "land_transport_training_centers_accreditation/rules/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Conditions and Procedures for Qualifying and Accrediting Training and Testing Centres for Land Transport Drivers and Operations Managers -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 1/4/1446H / 2024-10-04)"),
                "source_authority_ar": ("شروط وإجراءات تأهيل واعتماد مراكز التدريب ومراكز الاختبار لسائقي ومديري التشغيل في أنشطة النقل البري — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "land_transport_training_centers_accreditation",
        "layer": "LAND_TRANSPORT_TRAINING_CENTERS_ACCREDITATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "land-transport-training-centers-accreditation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (14 مادة، جميعها أصلية)",
        "title_en": "Conditions and Procedures for Qualifying and Accrediting Training and Testing Centres for Land Transport Drivers and Operations Managers — Arabic LLM-ready layer (14 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Conditions and Procedures for Qualifying and Accrediting Training and Testing Centres for Land Transport Drivers and Operations Managers records" % (len(ver), len(llm)))
