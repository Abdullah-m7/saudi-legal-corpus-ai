...
SRC = os.path.join(ROOT, "sources", "marina_design_operation_controls", "official_source",
                   "marina_design_operation_controls_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "marina_design_operation_controls", "verified")
RECORDS = os.path.join(OUT_VER, "marina_design_operation_controls_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "marina_design_operation_controls_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "marina_design_operation_controls_arabic_legal_llm",
...
def main():
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "marina_design_operation_controls",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "MARINA_DESIGN_OPERATION_CONTROLS_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "marina-design-operation-controls-llm-%03d" % idx,
            ...
            "article_path": "marina_design_operation_controls/rules/%s" % key,
    ...
    json.dump({
        "law_key": "marina_design_operation_controls",
        "layer": "MARINA_DESIGN_OPERATION_CONTROLS_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "marina-design-operation-controls-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (13 مادة، جميعها أصلية)",
        "title_en": "Controls and Procedures for the Design and Operation of Tourist Marinas — Arabic LLM-ready layer (13 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Controls and Procedures for the Design and Operation of Tourist Marinas records" % (len(ver), len(llm)))
