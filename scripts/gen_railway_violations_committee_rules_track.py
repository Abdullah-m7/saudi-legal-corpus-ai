...
SRC = os.path.join(ROOT, "sources", "railway_violations_committee_rules", "official_source",
                   "railway_violations_committee_rules_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "railway_violations_committee_rules", "verified")
RECORDS = os.path.join(OUT_VER, "railway_violations_committee_rules_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "railway_violations_committee_rules_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "railway_violations_committee_rules_arabic_legal_llm",
...
def main():
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "railway_violations_committee_rules",
            "law_component": "rules",
            "language": "ar",
            "record_layer": "RAILWAY_VIOLATIONS_COMMITTEE_RULES_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "railway-violations-committee-rules-llm-%03d" % idx,
            ...
            "article_path": "railway_violations_committee_rules/rules/%s" % key,
    ...
    json.dump({
        "law_key": "railway_violations_committee_rules",
        "layer": "RAILWAY_VIOLATIONS_COMMITTEE_RULES_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "railway-violations-committee-rules-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "rules",
