#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the ضوابط تربية النحل في محمية الملك عبدالعزيز الملكية track.
...
RECORDS = os.path.join(ROOT, "sources", "king_abdulaziz_reserve_beekeeping_controls", "verified",
                       "king_abdulaziz_reserve_beekeeping_controls_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "king_abdulaziz_reserve_beekeeping_controls", "verified",
                       "king_abdulaziz_reserve_beekeeping_controls_verified_summary.json")
LLM = os.path.join(ROOT, "data", "king_abdulaziz_reserve_beekeeping_controls_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"king_abdulaziz_reserve_beekeeping_controls_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "ضوابط تربية النحل في محمية الملك عبدالعزيز الملكية":
    ...
    if e:
        print("FAIL: %d error(s) in Controls for Beekeeping in the King Abdulaziz Royal Reserve track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Controls for Beekeeping in the King Abdulaziz Royal Reserve")
