...
EXPECTED_TOTAL = 1861
EXPECTED_PER_CORPUS = {"companies_law": 281, "pdpl": 81, "investment": 53, "civil": 721, "gtpl": 256, "labor": 469}
...
def main():
    ...
    print("  - companies_law 281 + pdpl 81 + investment 53 + civil 721 + gtpl 256 + labor 469; unique ids; text verbatim from source layers")
