...
SANITY = [
    ...
    ("مع مراعاة ما ورد في البند ( ثانيا ) من هذه المادة يعاقب بالقتل تعزيرا من ثبت شرعا بحقه شيء من الأفعال الآتية", "anti_narcotics", 37),
