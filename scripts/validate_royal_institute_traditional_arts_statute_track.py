#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Read-only validator for the تنظيم المعهد الملكي للفنون التقليدية track.
...
RECORDS = os.path.join(ROOT, "sources", "royal_institute_traditional_arts_statute", "verified",
                       "royal_institute_traditional_arts_statute_verified_records.jsonl")
SUMMARY = os.path.join(ROOT, "sources", "royal_institute_traditional_arts_statute", "verified",
                       "royal_institute_traditional_arts_statute_verified_summary.json")
LLM = os.path.join(ROOT, "data", "royal_institute_traditional_arts_statute_arabic_legal_llm",
...
FLAGGED_DISCREPANCY_KEYS = {"royal_institute_traditional_arts_statute_no_decision_number_in_source", "royal_institute_traditional_arts_statute_source_is_gazette_html_only"}
AR = "ء-ي"
...
def main():
    ...
    if src.get("document") != "تنظيم المعهد الملكي للفنون التقليدية":
    ...
    if e:
        print("FAIL: %d error(s) in Statute of the Royal Institute of Traditional Arts track:" % len(e))
        for x in e[:40]:
            print("  - %s" % x)
        return 1
    print("PASS: Statute of the Royal Institute of Traditional Arts")
