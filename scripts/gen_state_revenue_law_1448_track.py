#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the نظام إيرادات الدولة track.
...
server-rendered HTML page (uqn.gov.sa/decisions-and-regulations/4001570),
...
SRC = os.path.join(ROOT, "sources", "state_revenue_law_1448", "official_source",
                   "state_revenue_law_1448_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "state_revenue_law_1448", "verified")
RECORDS = os.path.join(OUT_VER, "state_revenue_law_1448_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "state_revenue_law_1448_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "state_revenue_law_1448_arabic_legal_llm",
                        "state_revenue_law_1448_legal_llm_001_030.json")

LAW_ID = "sa-state-revenue-law-1448"
LAW_AR = "نظام إيرادات الدولة"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"state_revenue_law_1448_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/decisions-and-regulations/4001570), published 24/2/1448H (2026-08-07). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "state_revenue_law_1448",
            "law_component": "law",
            "language": "ar",
            "record_layer": "STATE_REVENUE_LAW_1448_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "state-revenue-law-1448-llm-%03d" % idx,
            ...
            "article_path": "state_revenue_law_1448/law/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("State Revenue Law (1448H) -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 24/2/1448H / 2026-08-07)"),
                "source_authority_ar": ("نظام إيرادات الدولة — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "state_revenue_law_1448",
        "layer": "STATE_REVENUE_LAW_1448_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "state-revenue-law-1448-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "law",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (30 مادة، جميعها أصلية)",
        "title_en": "State Revenue Law (1448H) — Arabic LLM-ready layer (30 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready State Revenue Law (1448H) records" % (len(ver), len(llm)))
