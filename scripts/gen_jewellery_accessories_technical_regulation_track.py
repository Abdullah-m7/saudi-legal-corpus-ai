#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اللائحة الفنية لحلي الزينة والإكسسوارات track.
...
server-rendered HTML page (uqn.gov.sa/details?p=20155),
published 27/2/1444H (2022-09-23). The Gazette IS the official publication of record
...
SRC = os.path.join(ROOT, "sources", "jewellery_accessories_technical_regulation", "official_source",
                   "jewellery_accessories_technical_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "jewellery_accessories_technical_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "jewellery_accessories_technical_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "jewellery_accessories_technical_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "jewellery_accessories_technical_regulation_arabic_legal_llm",
                        "jewellery_accessories_technical_regulation_legal_llm_001_012.json")

LAW_ID = "sa-jewellery-accessories-technical-regulation"
LAW_AR = "اللائحة الفنية لحلي الزينة والإكسسوارات"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"jewellery_accessories_technical_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=20155), published 27/2/1444H (2022-09-23). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "jewellery_accessories_technical_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "JEWELLERY_ACCESSORIES_TECHNICAL_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "jewellery-accessories-technical-regulation-llm-%03d" % idx,
            ...
            "article_path": "jewellery_accessories_technical_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Technical Regulation for Costume Jewellery and Accessories -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 27/2/1444H / 2022-09-23)"),
                "source_authority_ar": ("اللائحة الفنية لحلي الزينة والإكسسوارات — النص الكامل جُلب مباشرة من صفحة جريدة أم "
                                        "القرى الرسمية (تاريخ النشر 27/2/1444هـ الموافق 2022-09-23م)"),
    ...
    json.dump({
        "law_key": "jewellery_accessories_technical_regulation",
        "layer": "JEWELLERY_ACCESSORIES_TECHNICAL_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "jewellery-accessories-technical-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (12 مادة، جميعها أصلية)",
        "title_en": "Technical Regulation for Costume Jewellery and Accessories — Arabic LLM-ready layer (12 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Technical Regulation for Costume Jewellery and Accessories records" % (len(ver), len(llm)))
