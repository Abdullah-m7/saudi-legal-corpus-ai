#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the لائحة اللجان الوطنية واللجان القطاعية في الغرف التجارية track.
...
server-rendered HTML page (uqn.gov.sa/details?p=24205),
...
SRC = os.path.join(ROOT, "sources", "chambers_commerce_committees_regulation", "official_source",
                   "chambers_commerce_committees_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "chambers_commerce_committees_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "chambers_commerce_committees_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "chambers_commerce_committees_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "chambers_commerce_committees_regulation_arabic_legal_llm",
                        "chambers_commerce_committees_regulation_legal_llm_001_042.json")

LAW_ID = "sa-chambers-commerce-committees-regulation"
LAW_AR = "لائحة اللجان الوطنية واللجان القطاعية في الغرف التجارية"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"chambers_commerce_committees_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=24205), published 24/5/1445H (2023-12-08). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "chambers_commerce_committees_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "CHAMBERS_COMMERCE_COMMITTEES_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "chambers-commerce-committees-regulation-llm-%03d" % idx,
            ...
            "article_path": "chambers_commerce_committees_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Regulation of National and Sectoral Committees in the Chambers of Commerce -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 24/5/1445H / 2023-12-08)"),
                "source_authority_ar": ("لائحة اللجان الوطنية واللجان القطاعية في الغرف التجارية — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "chambers_commerce_committees_regulation",
        "layer": "CHAMBERS_COMMERCE_COMMITTEES_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "chambers-commerce-committees-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (42 مادة، جميعها أصلية)",
        "title_en": "Regulation of National and Sectoral Committees in the Chambers of Commerce — Arabic LLM-ready layer (42 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Regulation of National and Sectoral Committees in the Chambers of Commerce records" % (len(ver), len(llm)))
