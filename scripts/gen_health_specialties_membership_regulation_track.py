...
server-rendered HTML page (uqn.gov.sa/details?p=27057),
published 7/9/1446H (2025-03-07). The Gazette IS the official publication of record
...
OUT_VER = os.path.join(ROOT, "sources", "health_specialties_membership_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "health_specialties_membership_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "health_specialties_membership_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "health_specialties_membership_regulation_arabic_legal_llm",
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=27057), published 7/9/1446H (2025-03-07). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "health_specialties_membership_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "HEALTH_SPECIALTIES_MEMBERSHIP_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "health-specialties-membership-regulation-llm-%03d" % idx,
            ...
            "article_path": "health_specialties_membership_regulation/regulation/%s" % key,
    ...
    json.dump({
        "law_key": "health_specialties_membership_regulation",
        "layer": "HEALTH_SPECIALTIES_MEMBERSHIP_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "health-specialties-membership-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
