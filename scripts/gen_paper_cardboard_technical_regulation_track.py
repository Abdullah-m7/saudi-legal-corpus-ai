#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the اللائحة الفنية للورق والكرتون track.
...
server-rendered HTML page (uqn.gov.sa/details?p=18108),
...
SRC = os.path.join(ROOT, "sources", "paper_cardboard_technical_regulation", "official_source",
                   "paper_cardboard_technical_regulation_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "paper_cardboard_technical_regulation", "verified")
RECORDS = os.path.join(OUT_VER, "paper_cardboard_technical_regulation_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "paper_cardboard_technical_regulation_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "paper_cardboard_technical_regulation_arabic_legal_llm",
                        "paper_cardboard_technical_regulation_legal_llm_001_011.json")

LAW_ID = "sa-paper-cardboard-technical-regulation"
LAW_AR = "اللائحة الفنية للورق والكرتون"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"paper_cardboard_technical_regulation_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=18108), published 5/1/1443H (2021-08-13). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "paper_cardboard_technical_regulation",
            "law_component": "regulation",
            "language": "ar",
            "record_layer": "PAPER_CARDBOARD_TECHNICAL_REGULATION_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "paper-cardboard-technical-regulation-llm-%03d" % idx,
            ...
            "article_path": "paper_cardboard_technical_regulation/regulation/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Technical Regulation for Paper and Cardboard -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 5/1/1443H / 2021-08-13)"),
                "source_authority_ar": ("اللائحة الفنية للورق والكرتون — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "paper_cardboard_technical_regulation",
        "layer": "PAPER_CARDBOARD_TECHNICAL_REGULATION_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "paper-cardboard-technical-regulation-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "regulation",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (11 مادة، جميعها أصلية)",
        "title_en": "Technical Regulation for Paper and Cardboard — Arabic LLM-ready layer (11 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Technical Regulation for Paper and Cardboard records" % (len(ver), len(llm)))
