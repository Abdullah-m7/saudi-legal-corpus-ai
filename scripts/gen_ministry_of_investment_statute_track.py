#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate the تنظيم وزارة الاستثمار track.
...
server-rendered HTML page (uqn.gov.sa/details?p=17727),
...
SRC = os.path.join(ROOT, "sources", "ministry_of_investment_statute", "official_source",
                   "ministry_of_investment_statute_official_source.json")
OUT_VER = os.path.join(ROOT, "sources", "ministry_of_investment_statute", "verified")
RECORDS = os.path.join(OUT_VER, "ministry_of_investment_statute_verified_records.jsonl")
SUMMARY = os.path.join(OUT_VER, "ministry_of_investment_statute_verified_summary.json")
LLM_PATH = os.path.join(ROOT, "data", "ministry_of_investment_statute_arabic_legal_llm",
                        "ministry_of_investment_statute_legal_llm_001_005.json")

LAW_ID = "sa-ministry-of-investment-statute"
LAW_AR = "تنظيم وزارة الاستثمار"
STATUS_UNCHANGED = "UNCHANGED"
ART_RE = r"ministry_of_investment_statute_art_(\d{3})$"
...
def main():
    ...
    gov_note = ("Arabic governs; PRIMARY full text fetched directly from the Umm Al-Qura "
                ...
                "(uqn.gov.sa/details?p=17727), published 23/10/1442H (2021-06-04). "
    ...
    for idx, key in enumerate(keys, start=1):
        ...
        text = a["text"]
        ver.append({
            "law_key": "ministry_of_investment_statute",
            "law_component": "statute",
            "language": "ar",
            "record_layer": "MINISTRY_OF_INVESTMENT_STATUTE_ARABIC_VERIFIED_TEXT",
            "article_number": n,
            "is_appendix": False,
        ...
        llm.append({
            ...
            "is_amended": ls == "معدلة",
            "text_complete": a.get("text_complete", True),
            "record_id": "ministry-of-investment-statute-llm-%03d" % idx,
            ...
            "article_path": "ministry_of_investment_statute/statute/%s" % key,
            ...
            "source_trust": {
                "source_authority": ("Statute of the Ministry of Investment -- full text fetched directly from the Umm "
                                     "Al-Qura Official Gazette's own HTML rendering "
                                     "(published 23/10/1442H / 2021-06-04)"),
                "source_authority_ar": ("تنظيم وزارة الاستثمار — النص الكامل جُلب مباشرة من صفحة جريدة أم "
    ...
    json.dump({
        "law_key": "ministry_of_investment_statute",
        "layer": "MINISTRY_OF_INVESTMENT_STATUTE_ARABIC_VERIFIED_TEXT",
    ...
    json.dump({
        "layer_id": "ministry-of-investment-statute-arabic-legal-llm-full",
        "law_id": LAW_ID,
        "law_component": "statute",
        "title_ar": LAW_AR + " — الطبقة العربية الجاهزة للنماذج اللغوية (5 مادة، جميعها أصلية)",
        "title_en": "Statute of the Ministry of Investment — Arabic LLM-ready layer (5 articles; all original)",
        "record_type": "verified_arabic_article",
        "language": "ar",
        "governing_text_language": "ar",
    ...
    print("Wrote %d verified + %d LLM-ready Statute of the Ministry of Investment records" % (len(ver), len(llm)))
