...
STATUS_TIER_MAP = {
    ...
    # aml_regulation rebuilt 2026-07-29 from Umm al-Qura's born-digital official gazette text,
    # cross-verified against aml.gov.sa's official scan (qanoniah.com as a third channel) —
...
RATIONALE_OVERRIDE = {
    ...
    "copyright_law": (
        ...
        "القديمة فقط. ملاحظة إضافية: القانون مؤكَّد أنه سيُستبدل اعتباراً من 2026-08-12 بموجب "
